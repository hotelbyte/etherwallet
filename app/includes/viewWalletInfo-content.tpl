    ...
    <div class="col-xs-11">
      <div class="account-help-icon">
        ...
        <p class="account-help-text" translate="x_AddessDesc">
          You may know this as your "Account #" or your "Public Key". It's what you send people so they can send you HBF. That icon is an easy way to recognize your address.
        </p>
    ...
    <div class="col-xs-12" ng-show='showEnc'>
      <div class="account-help-icon">
        ...
        <p class="account-help-text" translate="x_KeystoreDesc">
          This Keystore / JSON file matches the format used by Mist & Ghbc so you can easily import it in the future. It is the recommended file to download and back up.
        </p>
        <h5 translate="x_Keystore">
          Keystore/JSON File (Recommended • Encrypted • Mist/Ghbc Format)
        </h5>
      </div>
