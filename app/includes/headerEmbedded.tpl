...
<section class="container text-center">
  <a href="https://myhow.hotelbyte.foundation"><img src="images/logo-myhotelwallet.png" height="50px" width="64px" alt="MyHotelWallet" class="embedded-logo" /></a>
  <span>MyHotelWallet</span>
</section>
</header>
