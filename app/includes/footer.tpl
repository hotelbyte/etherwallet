<section class="pre-footer">
  <div class="container">
    <p>
      MyHotelWallet does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      <p>
        <span translate="FOOTER_1">
          Free, open-source, client-side interface for generating Hotelbyte wallets &amp; more. Interact with the Hotelbyte blockchain easily &amp; securely. Double-check the URL ( myhow.hotelbyte.foundation ) before unlocking your wallet.
        </span>
      </p>
      ...
      <p>
        &copy; 2018 Hotelbyte Foundation
      </p>
    ...
    <section class="footer--cent">
        ...
        <p>
          ...
          <span class="mono wrap">
            <a title="See this address on the blockchain explorer" href="https://commerce.coinbase.com/checkout/dc7f8be4-723f-4b09-aac9-182086c0d1b8" class="ext-etheraddresslookup-link" target="_blank">
    ...
    <section class="footer--righ">
      <p>
        <a aria-label="website via my hotel wallet dot foundation" href="https://myhow.hotelbyte.foundation" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          MyHow.hotelbyte.foundation
        </a>
      </p>
      <p>
        <a aria-label="website via hotelbyte dot org" href="https://hotelbyte.org" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Hotelbyte Foundation
        </a>
      </p>
      <p>
        <a href="https://myhow.hotelbyte.foundation/signmsg.html" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Sign Message
        </a>
      </p>
      <p>
        <a aria-label="download & run locally" href="https://github.com/hotelbyte/web-wallet/releases/latest" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
      ...
      <!-- p>
        <a aria-label="my ether wallet chrome extension" href="https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm?hl=en" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          MyHotelWallet Chrome Extension
        </a>
      </p>
      <p>
      ...
      <p>
        <a aria-label="twitter" title="twitter" href="https://twitter.com/hotelbyte" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/hotelbyte" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
