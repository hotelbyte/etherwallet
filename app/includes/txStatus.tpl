<main class="tab-pane block--container active" ng-if="globalService.currentTab==globalService.tabs.txStatus.id" ng-controller='txStatusCtrl' role="main" ng-cloak>
  ...
  <section class="block txstatus__2" ng-show="txInfo.status==txStatus.mined || txInfo.status==txStatus.notFound || txInfo.status==txStatus.found">
    ...
    <div class="cont-md" ng-show="txInfo.status == txStatus.mined">
      ...
      <h5> <a href="https://explorer.hotelbyte.org/txns/{{ tx.hash }}" target="_blank" rel="noopener noreferrer"> {{ tx.hash }} </a> </h5>
      ...
      <table class="table table-striped txstatus__2 cont-md"> <!-- ng-show="tx.status=='foundOnChain' || foundInPending'"-->
        <tbody>
          <tr>
            ...
            <td>
              <a href="https://explorer.hotelbyte.org/txns/{{ txInfo.hash }}" target="_blank" rel="noopener noreferrer">
                {{ txInfo.hash }}
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <a href="https://explorer.hotelbyte.org/accounts/{{ txInfo.from }}" target="_blank" rel="noopener noreferrer">
                {{ txInfo.from }}
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <a href="https://explorer.hotelbyte.org/accounts/{{ txInfo.to }}" target="_blank" rel="noopener noreferrer">
                {{ txInfo.to }}
              </a>
            </td>
          </tr>
