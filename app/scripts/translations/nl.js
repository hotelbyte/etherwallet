...
tx_notFound_4               : 'Gebruik het drop-down menu in de rechterbovenhoek & selecteer een andere HBF node (bijvoobeeld `HBF (Etherscan.io)` of `HBF (Infura.io)` of `HBF (MyHotelWallet)`) en check opnieuw.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via MyHotelWallet (of Mist, Ghbc, Parity en andere wallet clients.) ',
...
GAS_LIMIT_Desc              : 'Gas limiet is de hoeveelheid gas waarmee je je TX verstuurd. `TX vergoeding = gas prijs * gas limiet` & wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. Het verhogen van dit nummer zorgt er niet voor dat je TX sneller ge-mined zal worden. Verzenden van HBF = `21000`. Verzenden van Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> HBF converteren](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Een gratis, open source, client-side interface om Hotelbyte wallets te genereren &amp; meer. Wissel op een gemakkelijke &amp; veilige manier informatie uit met de Hotelbyte blockchain. Dubbel-check de URL/link ( myetherwallet.com ) alvorens je wallet te openen.',
...
ADD_Ledger_2                : 'Open de Hotelbyte applicatie (of een contract applicatie) ',
...
ADD_Ledger_0a               : 'Her-open MyHotelWallet met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open MyHotelWallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Verbind met Ledger Wallet ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Verbind met TREZOR ',
ADD_MetaMask                : 'Verbind met MetaMask ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Her-open MyHotelWallet met een veilige (SSL) verbinding ',
ADD_DigitalBitbox_0b        : 'Her-open MyHotelWallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met MyHotelWallet CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Een standaard transactie met 21000 gas zal 0.000441 HBF kosten. Wij gebruiken een iets-boven-minimum gas prijs van 0.000000021 HBF om te garranderen dat de transactie snel uitgevoerd zal worden. Wij zijn niet verantwoordelijk voor je transactie kosten. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met MyHow.hotelbyte.foundation te kunnen verbinden. Je kunt de [MyHotelWallet repo downloaden](https://github.com/kvhnuke/etherwallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
SWAP_init_2                 : " omwisselen voor ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Ontvangen! ", // HBF Received!
SWAP_progress_4             : "Verzenden van je {{orderResult.output.currency}} ",
SWAP_progress_5             : "Bestelling Voltooid ",
SWAP_order_CTA              : "Verzend alsjeblieft ", // Please send 1 HBF...
SWAP_unlock                 : "Open je Wallet op deze pagina om HBF of Tokens direct te verzenden. ",
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Hiermee kun je verschillende versies van je prive sleutels downloaden en je papieren wallet opnieuw afdrukken. Je zou dit kunnen doen om [je account in Ghbc/Mist te importeren](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Als je enkel je saldo wilt raadplegen, adviseren we je om gebruik te maken van een blockchain explorer zoals [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
ERROR_28                    : '**Je hebt je Keystore Bestand & wachtwoord of prive sleutel nodig** om toegang tot deze wallet te verkrijgen in de toekomst. Sla het op & maak een externe back-up! Er is geen enkele manier om je wallet te herstellen als je het nu niet opslaat. Lees ook de help pagina (https://myhow.hotelbyte.foundation/#help) voor instructies. ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Ongeldige verzender ',
GHBF_Nonce                  : 'Nonce te laag ',
GHBF_Cheap                  : 'Gas prijs te laag voor acceptatie ',
GHBF_Balance                : 'Ontoereikend saldo ',
GHBF_NonExistentAccount     : 'Account bestaat niet of account saldo te laag ',
GHBF_InsufficientFunds      : 'Ontoereikend saldo voor gas * prijs + waarde ',
GHBF_IntrinsicGas           : 'Intrinsiek gas te laag ',
GHBF_GasLimit               : 'Overstijgt blok gas limiet ',
GHBF_NegativeValue          : 'Negative waarde ',
...
TranslatorName_1            : '[h3ll0fr13nd](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xB5FbCE123F12347206c881cae73A3046BA1A90bA&value=1.0#send-transaction) ',
...
HELP_2a_Desc_3              : 'Bewaar versies van je prive sleutel. Deel deze niet met anderen. Je prive sleutel heb je nodig wanneer je toegang tot je HBF wilt om het te versturen! Er zijn drie soorten prive sleutels: ',
...
HELP_2b_Title               : '2b) Hoe doe ik veilig / offline / cold storage met MyHotelWallet? ',
...
HELP_3_Desc_3               : 'Navigeer naar de MyHow.hotelbyte.foundation "Bekijk Wallet Info" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik Ether met MyHotelWallet CX? ',
...
HELP_5_Title                : '5) Hoe voer ik MyHow.hotelbyte.foundation offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt MyHow.hotelbyte.foundation uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'MyHow.hotelbyte.foundation draait nu volledig op jouw computer. ',
HELP_5_Desc_8               : 'Voor het geval dat je er niet bekend mee bent: je hebt de volledige map nodig om de site lokaal te draaien, niet alleen het `index.html` bestand. Laat alle bestanden in de map met rust en ga ze niet verplaatsen. Als je een back-up wilt bewaren van de MyHotelWallet repo voor de toekomst, raden we je aan om alleen de ZIP te bewaren zodat je zeker weet dat de inhoud intact blijft. ',
HELP_5_Desc_9               : 'Gezien we MyHow.hotelbyte.foundation continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'MyHotelWallet is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als MyHow.hotelbyte.foundation er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Hotelbyte Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit MyHotelWallet halen omdat het niet in MyHotelWallet zit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
HELP_8_Desc_3               : 'Je kunt je  onversleutelde (unencrypted) prive sleutel en je Ghbc/Mist Formaat (encrypted) bestanden heel gemakkelijk en direct in geth / Hotelbyte Wallet / Mist importeren. Zie onderstaande vraag #12. ',
HELP_8_Desc_4               : 'Daarnaast is de kans dat wij MyHotelWallet offline halen is miniem tot onmogelijk. Het kost ons vrijwel niets om de site in stand te houden omdat we geen informatie opslaan. Als we toch het domijn offline halen, is het ook altijd nog publiekelijk beschikbaar op [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Je kunt daar de ZIP downloaden en het lokaal draaien. ',

HELP_8CX_Title              : '8) Wat gebeurd er als MyHotelWallet CX verdwijnt? ',
...
HELP_12_Title               : '12) Hoe importeer ik een MyHotelWallet  wallet in geth / Hotelbyte Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Ghbc/Mist JSON bestand van MyHotelWallet v2+.... ',
...
HELP_12_Desc_6              : 'Zoek naar de "Download JSON bestand - Ghbc/Mist Formaat (encrypted)" sectie. Druk op de "Download" knop eronder. Je hebt nu je keystore bestand. ',
HELP_12_Desc_7              : 'Open de Hotelbyte Wallet applicatie. ',
...
HELP_12_Desc_20             : 'Je zal gevraagd worden om een nieuw wachtwoord. Dit is het wachtwoord wat je zult gebruiken in geth / Hotelbyte Wallet / Mist elke keer als je een transactie verzend, dus zorg dat je dit niet vergeet. ',
HELP_12_Desc_21             : 'Verwijder het bestand `niets_bijzonders_verwijder_mij.txt` na een geslaagde import. ',
HELP_12_Desc_22             : 'De volgende keer dat je de Hotelbyte Wallet applicatie opent, zal je account worden vermeld onder "Accounts". ',
...
HELP_12_Desc_26             : 'Je zal gevraagd worden om een nieuw wachtwoord. Dit is het wachtwoord wat je zult gebruiken in geth / Hotelbyte Wallet / Mist elke keer als je een transactie verzend, dus zorg dat je dit niet vergeet. ',
HELP_12_Desc_27             : 'Verwijder het bestand `niets_bijzonders_verwijder_mij.txt` na een geslaagde import. ',
HELP_12_Desc_28             : 'De volgende keer dat je de Hotelbyte Wallet applicatie opent, zal je account worden vermeld onder "Accounts". ',
...
HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. MyHow.hotelbyte.foundation doet dit niet. Is de wikkeleurigheid (random number generation) van MyHotelWallet wel veilig? ',
HELP_14_Desc_1              : 'Hoewel het bewegen van de muis een slimme truck is en we begrijpen waarom mensen dit een goed idee vinden, is de werkelijkheid dat "window.crypto" een grotere willekeurigheid (hogere entropie) zeker stelt dan je muisbewegingen. De muisbewegingen zijn niet onveilig, echter wij (en enorm veel andere crypto experimenten) geloven in "window.crypto". Bovendien kan MyHow.hotelbyte.foundation gebruikt worden op touchscreen apparaten. Hier vind je een [conversatie tussen een boze redditor en Vitalik Buterin over de muisbewegingen v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_16_Desc_1              : 'Je kunt hiervoor een blockchain explorer gebruiken zoals bijvoorbeeld [explorer.hotelbyte.org](https://explorer.hotelbyte.org). Plak daar je adres in de zoekbalk en je adres en transactie geschiedenis zullen worden getoond. Bekijk bijvoobeeld hoe ons [donatie account](https://etherscan.io/address/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D)  eruit ziet op etherscan.io ',
...
HELP_21_Desc_2              : 'De lange ELI5 versie: Hotelbyte is gebasserd op [Publieke Sleutel Cryptografie](https://en.wikipedia.org/wiki/Public-key_cryptography), en meer specifiek op [Elliptische curve cryptografie](https://eprint.iacr.org/2013/734.pdf) wat op grote schaal gebruikt wordt, niet alleen in Hotelbyte. De meeste van onze servers zijn beveiligd via ECC. Bitcoin maakt hier ook gebruik van, net als SSH, TLS en vele andere dingen. De specifieke Hotelbyte sleutels zijn 256-bit sleutels, welke sterker zijn dan 128-bit en 192-bit, terwijl die ook op grote schaal gebruikt worden en no steeds als veilig worden beschouwd door experts. ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van MyHow.hotelbyte.foundation in plaats van deze Chrome Extensie. ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) naar de domein namen: [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation). ',
