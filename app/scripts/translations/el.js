...
tx_notFound_4               : 'Παρακαλούμε χρησιμοποιήστε το αναπτυσσόμενο μενού πάνω δεξιά και επιλέξτε κάποιον διαφορετικό κόμβο HBF (π.χ. `HBF (Etherscan.io)` ή `HBF (Infura.io)` ή `HBF (MyHotelWallet)`) και ελέγξτε ξανά.',
...
tx_FoundOnChain_3           : '**Αν δεν βλέπετε σφάλματα, η συναλλαγή σας εστάλη επιτυχώς.** Τα HBF σας ή οι μάρκες σας βρίσκονται εκεί που τα στείλατε. Αν δεν μπορείτε να δείτε αυτά τα HBF ή τις μάρκες να έχουν πιστωθεί στο άλλο σας πορτοφόλι ή στο λογαριασμό του ανταλλακτηρίου σας, και έχουν περάσει 24+ ώρες από τότε που τα στείλατε, παρακαλούμε [επικοινωνήστε με αυτήν την υπηρεσία](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Στείλτε τους το *σύνδεσμο* προς τη συναλλαγή σας και ζητήστε τους ευγενικά να ρίξουν μια ματιά στο θέμα σας.',
...
GEN_Help_12                 : 'Χρησιμοποιήστε το για να ξεκλειδώσετε το πορτοφόλι σας μέσω του MyHotelWallet (ή μέσω του Mist, του Geth, του Parity και άλλων προγραμμάτων-πελατών πορτοφολιού.) ',
...
TXFEE_Desc                  : 'Το τέλος συναλλαγής πληρώνεται στους μεταλλωρύχους για να συμπεριλάβουν τη συναλλαγή σας σε ένα μπλοκ. Είναι το `όριο αερίου` * `τιμή αερίου`. [Μπορείτε να μετατρέψετε GWEI -> HBF εδώ](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Ένα εργαλείο ανοιχτού κώδικα, javascript, από πλευράς πελάτη για τη δημιουργία πορτοφολιών Hotelbyte & αποστολή συναλλαγών. ',
...
TRANS_warning               : 'Άν χρησιμοποιείτε τις λειτουργίες «Μόνο HBF» ή «Μόνο ETC», η αποστολή γίνεται μέσω συμβολαίων. Ορισμένες υπηρεσίες παρουσιάζουν προβλήματα με την αποδοχή τέτοιων συναλλαγών. Διαβάστε περισσότερα. ',
TRANS_advanced              : '+Για προχωρημένους: Προσθήκη δεδομένων ',
TRANS_data                  : 'Δεδομένα ',
TRANS_gas                   : 'Όριο αερίου ',
TRANS_sendInfo              : 'Μία τυπική συναλλαγή που χρησιμοποιεί 21000 μονάδες αερίου θα κοστίσει 0,000441 HBF. Χρησιμοποιούμε για τιμή αερίου 0.000000021 HBF που είναι λίγο πάνω απο την ελάχιστη ώστε να διασφαλίσουμε ότι θα επικυρωθεί γρήγορα. Δεν παίρνουμε προμήθεια για τη συναλλαγή. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Συναλλαγές «Μόνο HBF» και «Μόνο ETC» ',
TRANSModal_Content_0        : 'Μια σημείωση για τις διάφορετικές συναλλαγές και διαφορετικές υπηρεσίες συναλλαγών: ',
TRANSModal_Content_1        : '**HBF (τυπική συναλλαγή): ** Αυτό παράγει μια προεπιλεγμένη συναλλαγή απευθείας από μια διεύθυνση σε μία άλλη. Έχει προεπιλεγμένο αέριο 21000. Είναι πιθανόν ότι κάθε HBF που αποστέλλεται μέσω αυτής της μεθόδου θα επαναληφθεί στην αλυσίδα ETC. ',
TRANSModal_Content_2        : '**Μόνο HBF: ** Αυτό αποστέλλει μέσω του [συμβολαίου προστασίας από επανάληψη του Timon Rapp (όπως συνιστάται από τον Vitalik Buterin)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) ώστε η αποστολή να γίνεται μόνο στην αλυσίδα **HBF**. ',
...
MYWAL_Content_3             : 'Αν θέλετε να χρησιμοποιήσετε το πορτοφόλι αυτό με το MyHotelWalletCX στο μέλλον, θα χρειαστεί να το ξαναπροσθέσετε χειροκίνητα χρησιμοποιώντας το ιδιωτικό κλειδί/JSON και το συνθηματικό. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Αυτό σας επιτρέπει να κατεβάσετε διαφορετικές εκδοχές των ιδιωτικών κλειδιών σας και να επανεκτυπώσετε το χάρτινο πορτοφόλι σας. Ίσως επιθυμείτε να το κάνετε προκειμένου να [εισαγάγετε το λογαριασμό σας στο Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Αν επιθυμείτε να ελέγξετε το υπόλοιπό σας, συνιστούμε να χρησιμοποιήσετε ένα εργαλείο εξερεύνησης blockchain όπως το [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
SWAP_init_2                 : " με ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Ελήφθησαν! ", // HBF Received!
SWAP_progress_4             : "Γίνεται αποστολή {{orderResult.output.currency}} ",
SWAP_progress_5             : "Η εντολή ολοκληρώθηκε ",
SWAP_order_CTA              : "Παρακαλούμε στείλτε ", // Please send 1 HBF...
SWAP_unlock                 : "Ξεκλειδώστε το πορτοφόλι σας για να στείλετε HBF ή μάρκες απευθείας από αυτήν τη σελίδα. ",
...
ADD_Ledger_2                : 'Ανοίξτε την εφαρμογή Hotelbyte (ή μια εφαρμογή συμβολαίου) ',
...
ADD_Ledger_0a               : 'Ξανα-ανοίξτε το MyHotelWallet σε ασφαλή (SSL) σύνδεση ',
ADD_Ledger_0b               : 'Ξανα-ανοίξτε το MyHotelWallet χρησιμοποιώντας το [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ERROR_17                    : 'Ο λογαριασμός από τον οποίο στέλνετε δεν έχει αρκετά κεφάλαια. Εάν στέλνετε μάρκες, πρέπει να έχετε 0.01 HBF στο λογαριασμό σας για να καλύψετε το κόστος του αερίου. ', // 17
...
ERROR_28                    : 'Προκειμένου να έχετε πρόσβαση σε αυτό το πορτοφόλι στο μέλλον **είναι απαραίτητο το αρχείο Keystore/JSON & το συνθηματικό ή το ιδιωτικό κλειδί σας**. Παρακαλούμε κρατήστε ένα εξωτερικό αντίγραφο ασφαλείας! Δεν υπάρχει τρόπος ανάκτησης ενός πορτοφολιού άν δεν το αποθηκεύσετε. Διαβάστε τη σελίδα [βοήθειας](https://myhow.hotelbyte.foundation/#help) για οδηγίες. ',
...
/* Messages */
GHBF_InvalidSender          : 'Μη έγκυρος αποστολέας ',
GHBF_Nonce                  : 'Το nonce είναι πολύ χαμηλό ',
GHBF_Cheap                  : 'Η τιμή αερίου είναι πολύ χαμηλή για να γίνει αποδεκτή ',
GHBF_Balance                : 'Μη επαρκές υπόλοιπο ',
GHBF_NonExistentAccount     : 'Ο λογαριασμός δεν υπάρχει ή το υπόλοιπο του λογαριασμού είναι πολύ χαμηλό ',
GHBF_InsufficientFunds      : 'Μη επαρκή κεφάλαια για αέριο * τιμή + αξία ',
GHBF_IntrinsicGas           : 'Το εγγενές αέριο είναι πολύ χαμηλό ',
GHBF_GasLimit               : 'Υπερβαίνει το όριο αερίου του μπλοκ ',
GHBF_NegativeValue          : 'Αρνητική αξία ',
...
TranslatorName_1            : '[VitalikFanBoy#117](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x245f27796a44d7e3d30654ed62850ff09ee85656&value=1.0#send-transaction) · ',
TranslatorAddr_1            : '0x245f27796a44d7e3d30654ed62850ff09ee85656 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : 'LefterisJP  · ',
TranslatorAddr_2            : '',
/* Translator 2             : Insert Comments Here */
TranslatorName_3            : '[Nikos Vavoulas](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x062711C89Bd46E9765CfF0b743Cb83a9dBA2d2d2&value=1.0#send-transaction) · ',
...
HELP_2b_Title               : '2β) Πώς μπορώ να έχω ασφάλεια / συναλλαγές εκτός σύνδεσης / ψυχρή αποθήκευση με το MyHotelWallet? ',
...
HELP_3_Desc_3               : 'Μεταβείτε στη σελίδα «Προβολή πληροφοριών ποστοφολιού» του MyHow.hotelbyte.foundation. ',
...
HELP_8_Desc_1               : 'Το MyHotelWallet δεν είναι πορτοφόλι ιστού. Δεν γίνεται σύνδεση χρήστη και τίποτα δεν αποθηκεύεται στους διακομιστές μας. Είναι απλά μια διεπαφή που σας επιτρέπει να αλληλεπιδράσετε με το blockchain. ',
HELP_8_Desc_2               : 'Αν το MyHow.hotelbyte.foundation πέσει, μπορείτε να χρησιμοποιήσετε κάποιον άλλον τρόπο (όπως το geth ή το Hotelbyte Wallet / Mist) για να κάνετε ό,τι κάνουμε. Αλλά δεν θα χρειαστεί να «βγάλετε» τον Αιθέρα σας από το MyHotelWallet επειδή δεν βρίσκεται μέσα στο MyHotelWallet. Βρίσκεται στο όποιο πορτοφόλι δημιουργήσατε μέσω του ιστοτόπου μας. ',
HELP_8_Desc_3               : 'Μπορείτε να εισαγάγετε πολύ εύκολα το μη κρυπτογραφημένο σας ιδιωτικό κλειδί και τα αρχεία σε φορμά Geth / Mist (κρυπτογραφημένα) απευθείας στο geth / Hotelbyte Wallet / Mist. Δείτε την ερώτηση Νο 12 παρακάτω. ',
HELP_8_Desc_4               : 'Επιπρόσθετα, η πιθανότητα να πέσει το MyHotelWallet είναι ελάχιστη έως ανύπαρκτη. Δεν μας κοστίζει σχεδόν τίποτα να το διατηρούμε, δεδομένου ότι δεν αποθηκεύουμε καμία πληροφορία. Εάν πάψει να λειτουργεί το όνομα χώρου, το MyHotelWallet εξακολουθεί να είναι και πάντα θα είναι διαθέσιμο δημοσίως στη διεύθυνση [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Μπορείτε να κατεβάσετε το ZIP και να το εκτελέσετε τοπικά. ',
...
HELP_14_Title               : '14) Ορισμένοι ιστότοποι τυχαιοποιούν την παραγωγή του ιδιωτικού κλειδιού μέσω κινήσεων του ποντικιού. Το MyHow.hotelbyte.foundation δεν το κάνει αυτό. Είναι ασφαλής η παραγωγή τυχαίων αριθμών για το MyHotelWallet; ',
HELP_14_Desc_1              : 'Ενώ αυτό το πράγμα με τις κινήσεις του ποντικιού είναι έξυπνο και καταλαβαίνουμε γιατί αρέσει στους περισσότερους ανθρώπους, η πραγματικότητα όμως είναι ότι το window.crypto εξασφαλίζει περισσότερη εντροπία από τις κινήσεις του ποντικιού σας. Δεν είναι ότι οι κινήσεις του ποντικιού δεν είναι ασφαλείς, είναι ότι εμείς (και οι τόνοι πειραμάτων κρυπτογράφησης) πιστεύουμε στο window.crypto. Επιπλέον, το MyHow.hotelbyte.foundation μπορεί να χρησιμοποιηθεί σε συσκευές αφής. Εδώ είναι μια [συζήτηση μεταξύ ενός θυμωμένου redditor και του Vitalik Buterin σχετικά με τις κινήσεις του ποντικιού έναντι του window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) και εδώ είναι οι [προδιαγραφές w3 του window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
