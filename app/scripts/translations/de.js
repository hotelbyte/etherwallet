...
tx_notFound_4               : 'Bitte benutzen Sie das DropDown Menü oben-rechts & wählen Sie eine andere Node aus (z.B. `HBF (Etherscan.io)` oder `HBF (Infura.io)` oder `HBF (MyHotelWallet)`) und prüfen es erneut.',
...
tx_FoundOnChain_3           : '**Wenn sie keine Fehlernachrichten bekommen, wurde ihre Transaktion erfolgreich versendet.** Ihre HBF oder Tokens sind dort, wohin sie versendet wurden. Wenn Sie die HBF or Tokens nicht im anderen Wallet / Exchange account sehen können, und es schon mehr als 24 Stunden her ist, seitdem Sie gesendet haben, bitte [Kontaktieren Sie den Service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Senden Sie den *link* zu ihrer Transaktion und fragen Sie höflich, die Situation anzuschauen.',
...
GEN_Help_12                 : 'Nutze es um dein Wallet bei MyHotelWallet (oder Mist, Ghbc, Parity und andere Wallet Clients.) zu öffnen ',
...
TXFEE_Desc                  : 'Die Transaktionsgebühr wird den Miner(n) bezahlt, die Ihre Transaktion in einen Block einschließen. Es wird durch `Gas-Limit` * `Gas-Preis` berechnet. [Du kannst GWEI -> HBF hier umwandeln](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Ein quelloffenes, browserseitiges Werkzeug zur Erzeugung von Hotelbyte-Wallets und Versenden von Transaktionen. ',
...
TRANS_warning               : 'Wenn Sie die "Nur HBF" oder "Nur ETC" Funktionen benutzen, erfolgt die Transaktion über einen Vertrag. Einige Dienste haben ein Problem damit diese Transaktionen zu empfangen. Mehr lesen. ',
TRANS_advanced              : '+Fortgeschritten: Daten hinzufügen ',
TRANS_data                  : 'Daten ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Eine Standard Transaktion mit 21000 Gas kostet 0.000441 HBF. Wir zahlen einen minimal höheren Gaspreis von 0.000000021 HBF um zu garantieren, dass die Transaktion schnell bearbeitet wird. Wir erheben keine Transaktionsgebühren. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Nur HBF" und "Nur ETC" Transaktionen ',
TRANSModal_Content_0        : 'Ein Hinweis zu den verschiedenen Transaktionen und Angeboten ',
TRANSModal_Content_1        : '**HBF (Standard Transaktion): ** Dies erzeugt eine Standard Transaktion direkt von einer Adresse zu einer anderen. Diese nutzt standardmässig 21000 Gas. Es ist gut möglich, dass alle Transaktionen dieser Art auf der ETC Blockchain wiederholt werden (Replay Attacke). ',
TRANSModal_Content_2        : '**Nur HBF: ** Dies sendet die Transaktion so über [Timon Rapp\'s "replay protection contract" (wie von VB empfohlen)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), dass sie nur auf der **HBF** Blockchain ausgeführt wird. ',
...
MYWAL_Content_3             : 'Wenn Sie dieses Wallet in Zukunft mit MyHotelWallet CX verwenden wollen, müssen Sie es mittels des privaten Schlüssels/JSON Datei und Ihrem Passwort manuell wieder hinzufügen. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Dies erlaubt Ihnen, den Download verschiedener Versionen Ihres privaten Schlüssels sowie das erneute Drucken Ihres Papier-Wallets. Es wird empfohlen, dies zu tun um [Ihren Account in Ghbc/Mist zu importieren.](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Zum Überprüfen Ihres Kontostands empfehlen wir, einen Blockchain Explorer wie [explorer.hotelbyte.org](https://explorer.hotelbyte.org) zu verwenden. ',
...
SWAP_init_2                 : " gegen ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Erhalten! ", // HBF Received!
SWAP_progress_4             : "Sende Ihre {{orderResult.output.currency}} ",
SWAP_progress_5             : "Auftrag erfüllt ", //Vielleicht erledigt!
SWAP_order_CTA              : "Bitte sende ", // Please send 1 HBF...
SWAP_unlock                 : "Schalten Sie Ihr Wallet frei um HBF oder Tokens direkt von dieser Seite aus zu senden ",
...
ADD_Ledger_2                : 'Öffne das Hotelbyte Programm (oder ein Vertragsprogramm) ', //Statt Programm -> Applikation?
...
ERROR_17                    : 'Unzureichendes Guthaben für Gasverbrauch * Gaspreis + Wert. Du brauchst **0.01 HBF** in deinem Account um die Gaskosten zu decken. Bitte füge HBF hinzu und versuche es noch einmal. ',
...
ERROR_28                    : '**Du benötigst deine Keystore-Datei & das Passwort** (oder den privaten Schlüssel) um künftig auf dein Wallet zugreifen zu können. Bitte sichere diese Datei daher auf einem externen Medium! Es gibt KEINE Möglichkeit, ein Wallet wiederherzustellen, wenn du diese Datei und das Passwort nicht sicherst. Lies die [Hilfe-Seite](https://myhow.hotelbyte.foundation/#help) für weitere Informationen. ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Invalid sender Ungültiger Sender ',
GHBF_Nonce                  : 'Nonce too low  ',
GHBF_Cheap                  : 'Gaspreis zu niedrig! ', //Gas price too low for acceptance!
GHBF_Balance                : 'Nicht genügend Guthaben ',
GHBF_NonExistentAccount     : 'Account existiert nicht oder besitzt nicht genügend Guthaben ',
GHBF_InsufficientFunds      : 'Unzureichendes Guthaben für Gasverbrauch * Gaspreis + Wert ',
GHBF_IntrinsicGas           : 'Intrinsic gas too low ',
GHBF_GasLimit               : 'Exceeds block gas limit ',
GHBF_NegativeValue          : 'Negativer Wert ',
...
TranslatorName_2            : '[mawalu](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3&value=1.0#send-transaction) · ',
TranslatorAddr_2            : '0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3 ',
/* Translator 2             : Insert Comments Here */
TranslatorName_3            : '[huhn_solo](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x1DAd1765381460db9A44846cDfA6f74c65A06B77&value=1.0#send-transaction) · ',
TranslatorAddr_3            : '0x1DAd1765381460db9A44846cDfA6f74c65A06B77 ',
/* Translator 3             : Insert Comments Here */
TranslatorName_4            : '[FelixA](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D&value=1.0#send-transaction) · ',
TranslatorAddr_4            : '0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D ',
/* Translator 4             : Insert Comments Here */
TranslatorName_5            : 'danielsun174 · ffidan61 · [u/Preisschild](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x700Eb9142a0CC709fce80709cfbF5Ac25438c584&value=0.1#send-transaction) ',
TranslatorAddr_5            : '',
...
HELP_0_Desc_1               : 'MyHotelWallet bietet dir die Möglichkeit neue Wallets zu generieren, damit du deinen Ether selbst speichern kannst, und keine Exchange nutzen musst. Dieser Prozess findet ausschließlich auf deinem Computer statt. Daher bist auch **du dafür Verantwortlich, Back-ups zu erstellen** wenn du ein Wallet verwenden möchtest. ',
...
HELP_4CX_Title              : '4) Wie kann ich Ether über MyHotelWallet CX senden? ',
...
HELP_5_Title                : '5) Wie kann ich MyHow.hotelbyte.foundation offline/lokal starten? ',
