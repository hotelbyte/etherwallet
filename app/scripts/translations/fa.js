...
X_HelpfulLinks_4                :  'Migrating to/from MyHotelWallet',
...
ENS_Finalize_content            :  'Finalizing this name assigns the ENS name to the winning bidder. The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 HBF. Any non-winners will also be refunded.',
...
ENS_Helper_4                    :  'Decide the maximum amount of HBF you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 HBF for gas.',
...
ENS_Helper_16                   :  'The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 HBF.',
...
ENS_Helper_21                   :  'Announcing the Hotelbyte Name Service Relaunch Date!',
...
EOS_06                          :  'Go to Send Hotelcoin & Tokens Page',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to MyHotelWallet',
...
ONBOARD_welcome_content__4      :  'What is MyHOW? ',
ONBOARD_welcome_content__5      :  'MyHotelWallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'MyHotelWallet is not a Bank',
...
ONBOARD_interface_title         :  'MyHotelWallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on MyHotelWallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you HBF or tokens. 👍',
ONBOARD_interface_content__7    :  'If you send your *private key* to someone, they now have full control of your account. 👎',
ONBOARD_bank_title__alt         :  'MyHOW isn\'t a Bank',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from MyHotelWallet, MetaMask, Exodus, Mist, Ghbc, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on MyHotelWallet or view your transactions on [explorer.hotelbyte.org](https://explorer.hotelbyte.org), you are seeing data on the blockchain, not in our personal systems.',
ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
ONBOARD_interface_title__alt    :  'MyHOW is an Interface',
...
ONBOARD_blockchain_title__alt   :  'WTF is a Blockchain?',
ONBOARD_point_title__alt        :  'What\'s the Point of MyHOW then?',
ONBOARD_whymew_title            :  'If MyHotelWallet can\'t do those things, what\'s the point?',
...
ONBOARD_whymew_content__6       :  'f you are scared but want to use MyHOW, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like MyHotelWallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
...
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://myhow.hotelbyte.foundation`.',
ONBOARD_secure_1_content__4     :  'Always make sure the URL bar has `MYHBFERWALLET LLC` in green.',
...
ONBOARD_final_content__3        :  'How to Set up MyHOW + MetaMask',
ONBOARD_final_content__4        :  'How to Run MyHOW Offline / Locally',
...
ADD_Ledger_2: 'برنامه Hotelbyte را باز کنید (یا یک برنامه قرارداد را) ',
...
ADD_Ledger_0a: 'با یک کانکشن امن (SSL) دوباره MyHotelWallet را باز کنید. ',
ADD_Ledger_0b: 'با استفاده از [Chrome](https://www.google.com/chrome/browser/desktop/) یا [Opera](https://www.opera.com/) دوباره MyHotelWallet را باز کنید. ',
...
MYWAL_Content_3: ',اگر در آینده بخواهید از این کیف پول با استفاده از  MyHotelWallet CX خود استفاده کنید، باید بصورت دستی دوباره آن را اضافه کنید. این کار با استفاده از key/JASON و رمزعبور انجام می شود.',
...
// "/* full sentence reads ""You are about to send ""10 HBF"" to address ""0x1234"". Are you sure you want to do this? "" */" : "شما در حال ارسال ""10 اتر"" به آدرس ""0x1234"" هستید. آیا از این کار اطمینان دارید؟ ',
...
TRANS_warning: 'اگر از توابع ""فقط HBF"" یا ""فقط ETC"" استفاده می کنید، شما در حال ارسال از طریق یک قرارداد هستید. برخی از سرویس ها با قبول چنین تراکنش هایی مشکل دارند. بیشتر ',
...
SWAP_init_2: ' for , // ""I want to swap my X HBF for X BTC',
SWAP_init_CTA: 'ادامه ',
...
SWAP_progress_3: 'Received! , // HBF Received!',
SWAP_progress_4: 'Sending your {{orderResult.output.currency}} ,',
SWAP_progress_5: 'Order Complete ,',
SWAP_order_CTA: 'Please send , // Please send 1 HBF...',
SWAP_unlock: 'Unlock your wallet to send HBF or Tokens directly from this page. ',
...
GHBF_Balance                    :  '(geth-01) موجودی کافی نیست. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_Cheap                      :  '(geth-02) قیمت سوخت برای پذیرفته شدن کم است. Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right.',
GHBF_GasLimit                   :  '(geth-03) سوخت بیش از حد است. Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
GHBF_InsufficientFunds          :  '(geth-04) موجودی برای سوخت * قیمت + مقدار کافی نیست. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_IntrinsicGas               :  '(geth-05) سوخت اصلی کم است. Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again.',
GHBF_InvalidSender              :  '(geth-06) ارسال کننده نامعتبر است. Invalid sender.',
GHBF_NegativeValue              :  '(geth-07) مقدار منفی. Negative value.',
GHBF_Nonce                      :  "(geth-08) This TX's [nonce](https://myetherwallet.github.io/knowledge-base/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://myetherwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html).",
GHBF_NonExistentAccount         :  '(geth-09) حساب وجود ندارد و یا موجودی حساب کم است. Account does not exist or account balance too low',
...
HELP_4CX_Title: 'سوال 4: چگونه با کیف پول MyHotelWallet خود اتر ارسال کنم؟ ',
...
HELP_5_Title: 'سوال 5: چگونه از MyHow.hotelbyte.foundation بصورت آفلاین استفاده کنم؟ ',
HELP_5_Desc_1: 'شما می توانید MyHow.hotelbyte.foundation را به جای اجرا از روی سرورهای GitHub، روی کامپیوتر خود اجرا کنید. شما می توانید یک کیف پول را کاملا بصورت آفلاین بسازید و تراکنشی را از طریق صفحه ""تراکنش آفلاین"" ارسال کنید. ',
HELP_5_Desc_7: 'حال MyHow.hotelbyte.foundation بطور کامل در حال اجرا شدن از روی کامپیوتر شماست. ',
HELP_5_Desc_8: 'در صورتی که با این موضوع آشنایی ندارید بهتر است بدانید که باید تمام پوشه (فولدر) را نگهداری کنید تا بتوانید وبسایت را اجرا کنید (نه فقط index.html را). به چیزی در این پوشه دست نزنید و یا جابجا نکنید. اگر یک نسخه پشتیبان از کد مخزن MyHotelWallet را برای آینده نگهداری می کنید پیشنهاد می شود که تنها ZIP را نگهداری کنید تا از اینکه تمام محتوای پوشه درست ذخیره می شوند اطمینان حاصل کنید. ',
HELP_5_Desc_9: 'از آنجایی که ما بطور مداوم در حال بروزرسانی MyHow.hotelbyte.foundation هستیم، پیشنهاد می کنیم که نسخه ذخیره شده خود را بصورت دوره ای بروزرسانی کنید. ',
...
HELP_8_Desc_1: 'وبسایت MyHotelWallet یک کیف پول وبی نیست. نیازی نیست که وارد شوید (لاگین کنید) و هیچ چیزی بر روی سرورهای ما ذخیره نمی شود. این تنها یک ظاهر است که به شما امکان برقراری ارتباط با بلاکچین را می دهد. ',
HELP_8_Desc_2: 'اگر  MyHow.hotelbyte.foundation از کار بیافتد، راه دیگری (مثل geth یا Hotelbyte Wallet/ Mist) وجود دارد که کاری که ما انجام می دهیم را انجام دهد. اما نیازی نیست که اترهای خود را از  MyHotelWallet بیرون بیاورید چرا که آن ها در  MyHotelWallet نیستند، بلکه در هر کیف پولی ست که شما از طریق سایت ما ساخته باشید. ',
HELP_8_Desc_3: 'می توانید فایل های کلید خصوصی رمزنگاری نشده و Ghbc/Mist Format (رمزنگاری شده) را مستقیما به geth/ Hotelbyte Wallet/ Mist انتقال دهید. به سوال شماره 12 مراجعه کنید. ',
HELP_8_Desc_4: 'علاوه بر این، امکان اینکه  MyHotelWallet را از کار بیاندازیم نزدیک به صفر است. ازآنجایی که هیچ اطلاعاتی را ذخیره نمی کنیم در نتیجه هیچ هزینه نگهداری هم برای ما ندارد. اگر دامنه را به هر دلیلی از کار بیاندازیم، بصورت عمومی در آدرس های زیر در دسترس خواهد بود. [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) . می توانید از آنجا ZIP را دانلود کنید و آن را بصورت محلی راه اندازی و اجرا کنید. ',

HELP_8CX_Title: 'سوال 8: اگر  MyHotelWallet CX ناپدید شود چه اتفاقی میافتد؟ ',
...
HELP_8CX_Desc_2: 'مهم است در نظر داشته باشید که برای هر کیف پولی که با  MyHotelWallet CX ساخته می شود، از تمام اطلاعات خود یک نسخه پشتیبان تهیه کنید. در اینصورت اگر هر اتفاقی برای  MyHotelWallet CX یا کامپیوترتان بیافتد، همچنان اطلاعات لازم جهت دسترسی به اترهای خود را خواهید داشت. به سوال 2 الف برای چگونگی تهیه نسخه پشتیبان از کیف پول مراجعه کنید. ',
HELP_8CX_Desc_3: 'اگر به هر دلیلی  MyHotelWallet CX از Chrome Store ناپدید شد، می توانید سورس (کد منبع) آن را از Github پیدا کرده و بصورت دستی اجرا کنید. به سوال شماره 5 مراجعه کنید. ',
...
HELP_12_Title: 'سوال 12: چگونه کیف پولی که با MyHotelWallet ساخته ام را به geth یا Hotelbyte Wallet یا Mist منتقل کنم؟ ',
HELP_12_Desc_1: ',با استفاده از فایل Geth یا Mist JSON از MyHotelWallet نسخه 2 به بالا.',
...
HELP_12_Desc_7: 'برنامه کیف پول Hotelbyte Wallet را باز کنید. ',
...
HELP_12_Desc_20: 'این کار باعث می شود تا از شما در خواست یک رمزعبور جدید شود. این رمزعبوری ست که در زمان ارسال یک تراکنش با استفاده از geth یا Hotelbyte Wallet یا Mist از آن استفاده می کنید، در نتیجه آن را به خاطر بسپارید. ',
HELP_12_Desc_21: 'HELP_12_Desc_21',
HELP_12_Desc_22: 'دفعه بعد که برنامه Hotelbyte Wallet را باز کنید، حساب شما در بخش ""حساب ها"" قابل مشاهده خواهد بود. ',
...
HELP_12_Desc_26: 'این کار باعث می شود تا از شما در خواست یک رمزعبور جدید شود. این رمزعبوری ست که در زمان ارسال یک تراکنش با استفاده از geth یا Hotelbyte Wallet یا Mist از آن استفاده می کنید، در نتیجه آن را به خاطر بسپارید. ',
HELP_12_Desc_27: 'بعد از انتقال موفق، فایل  `nothing_special_delete_me.txt` را پاک کنید. ',
HELP_12_Desc_28: 'دفعه بعد که برنامه Hotelbyte Wallet را باز کنید، حساب شما در بخش ""حساب ها"" قابل مشاهده خواهد بود. ',
...
HELP_13_Desc_1: 'این بدان معناست که در حساب خود به اندازه کافی اتر (ٍHBF) جهت پرداخت هزینه سوخت را ندارید. هر تراکنش (که شامل توکن و تراکنش های قراردادی نیز می شود) به سوخت نیاز دارد و این سوخت با اتر پرداخت می شود. عددی که نمایش داده شد، مقداری ست که برای پوشش هزینه تراکنش در Wei مورد نیاز است. آن عدد را بر `1000000000000000000` تقسیم کنید و از مقدار اتری که می خواستید ارسال کنید کم کنید (اگر می خواستید که اتر ارسال کنید). این کار به شما میزان اتری که برای انجام تراکنش باید به آن حساب بفرستید را مشخص می کند. ',

HELP_14_Title: 'سوال 14: برخی از سایت ها ساخت رندوم یا تصادفی کلیدهای خصوصی را بر اساس حرکت موس انجام می دهند. سایت MyHow.hotelbyte.foundation این کار را انجام نمی دهد. آیا تولید تصادفی اعداد برای MyHotelWallet امن است؟ ',
HELP_14_Desc_1: 'روش ساخت بر اساس حرکت موس هوشمندانه است و می دانیم که  چرا مردم آن را دوست دارند، اما واقعیت این است که window.crypto ؟؟؟؟؟ بیشتری را نسبت به حرکات موس شما ارائه می کنند. حرکات موس ناامن نیستند اما ما (و بسیاری از آزمایش های کریپتو دیگر) در window.crypto باور بیشتری داریم. بعلاوه اینکه از MyHow.hotelbyte.foundation می توان در دستگاه های لمسی نیز استفاده کرد. در [اینجا می توانید بحث بین یک نویسنده عصبانی در reddit و Vitalik Buterin درباره حرکات موس و window.crypto را ببینید](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_16_Desc_1: 'برای این کار می توانید از یک مرورگر بلاکچین مثل  [explorer.hotelbyte.org](https://explorer.hotelbyte.org) استفاده کنید. آدرس خود را در قسمت search (جستجو) وارد کنید و بعد می توانید آدرس و سابقه تراکنش های خود را مشاهده کنید. برای مثال حساب اهدایی ما [بدین صورت](https://etherscan.io/address/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) است. ',
...
HELP_SecCX_Title: 'امنیت - MyHotelWallet CX ',
...
HELP_SecCX_Desc_6: 'اگر می خواستیم این موارد را رمزنگاری کنیم، هربار که می خواستید موجودی حساب یا نام های اختصاری را ببینید مجبور به وارد کردن رمزعبور می شدید. اگر این موضوع برایتان مهم است، پیشنهاد می کنیم از MyHow.hotelbyte.foundation به جای این Chrome Extension استفاده کنید. ',
...
HELP_Sec_Desc_4: 'این سایت از طریق GitHub ارائه می شود، می توانید کد اصلی یا Source Code آن را در این آدرس ببینید:  [https://github.com/kvhnuke/etherwallet/tree/gh-](https://github.com/kvhnuke/etherwallet/tree/gh-pages) و [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation). ',
