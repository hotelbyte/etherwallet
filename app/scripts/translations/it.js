...
tx_notFound_4               : 'Utilizza il menu a discesa in alto a destra e scegli un altro nodo HBF (ad esempio `HBF (Etherscan.io)` o `HBF (Infura.io)` o `HBF (MyHotelWallet)`) e ricontrolla.',
...
tx_FoundOnChain_3           : '**Se non vedi errori, la transazione è stata inviata correttamente.** I tuoi HBF o i tuoi token sono dove li hai inviati. Se non vedi questi HBF o token nell\'altro portafoglio / nel conto della piattaforma di scambio, e se sono passate più di 24 ore dall\'invio, [contatta quel servizio esterno](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Invia loro il *link* alla transazione e chiedi, cortesemente, di controllare la tua situazione.',
...
GEN_Help_12                 : 'Usalo per sbloccare il portafoglio tramite MyHotelWallet (o Mist, Ghbc, Parity e altri client.) ',
...
TXFEE_Desc                  : 'La commissione transazione si paga ai *miner* perché includano la transazione in un blocco. Si calcola come `limite gas` * `prezzo gas`. [Puoi calcolare la conversione GWEI -> HBF qui](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Interfaccia gratuita, open source, lato client per generare portafogli Hotelbyte e altro. Interagisci con la *blockchain* Hotelbyte facilmente e in modo sicuro. Controlla bene l\'URL ( myetherwallet.com ) prima di sbloccare un portafoglio.',
FOOTER_1b                   : 'Creato da ',
...
sidebar_donation            : 'MyHotelWallet è un servizio gratuito e open-source votato alla tua privacy e sicurezza. Più donazioni riceviamo, più tempo dedichiamo a creare nuove funzionalità, considerare i tuoi commenti, e darti ciò che vuoi. Siamo solo due persone che provano a cambiare il mondo. Ci aiuti? ',
sidebar_donate              : 'Dona ',
...
TRANS_sendInfo              : 'Una transazione standard che utilizza 21000 gas costerà 0,000441 HBF. Utilizziamo un prezzo del gas leggermente al di sopra del minimo pari a 0,000000021 HBF per assicurarci che venga elaborata velocemente. Noi non prendiamo commissioni. ',
...
MYWAL_Content_3             : 'Se vorrai utilizzare questo portafoglio con MyHotelWallet CX in futuro, dovrai ri-aggiungerlo manualmente tramite la chiave privata/JSON e password. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Qui è possibile scaricare diverse versioni delle chiavi private e ristampare il portafoglio cartaceo. Potresti volerlo fare per  [importare il tuo conto in Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Se vuoi controllare il tuo saldo, ti consigliamo di utilizzare uno strumento per esplorare la *blockchain* come [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
ADD_Ledger_0a               : 'Devi accedere a MyHotelWallet tramite una connessione sicura (SSL / HTTPS) per poterti collegare. ',
ADD_Ledger_0b               : 'Riapri MyHotelWallet utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
ADD_Ledger_1                : 'Collega il tuo Ledger Wallet ',
ADD_Ledger_2                : 'Apri l\'applicazione Hotelbyte (o l\'applicazione di un contratto) ',
...
ADD_DigitalBitbox_0a        : 'Riapri MyHotelWallet su una connessione sicura (SSL) ',
ADD_DigitalBitbox_0b        : 'Riapri MyHotelWallet utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Il tuo nodo deve utilizzare HTTPS per potertici collegare da MyHow.hotelbyte.foundation. Puoi [scaricare il repository di MyHotelWallet ed eseguirlo in locale](https://github.com/kvhnuke/etherwallet/releases/latest) per collegarti ad altri tipi di nodo. Oppure, ottieni un certificato SSL gratuito tramite [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_progress_3             : "ricevuti! ", // HBF Received!
SWAP_progress_4             : "Invio dei tuoi {{orderResult.output.currency}} ",
SWAP_progress_5             : "Ordine completato ",
SWAP_order_CTA              : "Invia ", // Please send 1 HBF...
SWAP_unlock                 : "Sblocca il tuo portafoglio per inviare HBF o token direttamente da questa pagina. ",
...
ERROR_17                    : 'L\'account dal quale stai provando ad inviare la transazione non ha abbastanza fondi. Se stai inviando token, ti servono 0,01 HBF nel conto per coprire i costi del gas. ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Mittente non valido ',
GHBF_Nonce                  : 'Nonce troppo basso ',
GHBF_Cheap                  : 'Prezzo del gas troppo basso per essere accettato ',
GHBF_Balance                : 'Saldo insufficiente ',
GHBF_NonExistentAccount     : 'Il conto non esiste o il saldo è insufficiente ',
GHBF_InsufficientFunds      : 'Fondi insufficienti per gas * prezzo + valore ',
GHBF_IntrinsicGas           : 'Gas intrinseco troppo basso ',
GHBF_GasLimit               : 'Eccede il limite gas per il blocco ',
GHBF_NegativeValue          : 'Valore negativo ',
...
TranslatorName_1            : '[ugilio](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x07932bc1c68c8ff188f4225e892178ab6d8c4eaa&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : '**Hotelbyte, MyHow.hotelbyte.foundation & MyHotelWallet CX, e alcune delle librerie Javascript che utilizziamo sono in continuo sviluppo.** Anche se abbiamo testato approfonditamente e persone di tutto il mondo hanno correttamente creato decine di migliaia di portafogli, c\'è sempre la remota possibilità che accada qualcosa di imprevisto che provochi la perdita dei tuoi HBF. Ti preghiamo di non investire più di quello che sei disposto a perdere, e di fare attenzione. Se dovesse capitare qualcosa, ci dispiace, ma **non siamo responsabili per gli ether perduti**. ',
HELP_Remind_Desc_2          : 'MyHow.hotelbyte.foundation & MyHotelWallet CX non sono "portafogli web". Non stai creando un account né ci stai dando i tuoi ether da custodire. Tutti i dati non lasciano mai il tuo computer/il tuo browser. Quello che facciamo è renderti facile creare, salvare, e accedere alle tue informazioni e interagire con la *blockchain*. ',
...
HELP_2b_Title               : '2b) Come implemento un portafoglio offline in maniera sicura con MyHotelWallet? ',
...
HELP_3_Desc_3               : 'Vai alla pagina "Informazioni portafoglio" su MyHow.hotelbyte.foundation. ',
...
HELP_4CX_Title              : '4) Come invio degli ether utilizzando MyHotelWallet CX? ',
...
HELP_5_Title                : '5) Come faccio ad eseguire MyHow.hotelbyte.foundation offline/in locale? ',
HELP_5_Desc_1               : 'Puoi eseguire MyHow.hotelbyte.foundation sul tuo computer invece che dai server di GitHub. Puoi generare un portafoglio completamente offline e inviare transazioni dalla pagina "Invia Offline". ',
HELP_5_Desc_7               : 'MyHow.hotelbyte.foundation è ora in esecuzione completamente sul tuo computer. ',
HELP_5_Desc_8               : 'In caso tu non abbia molta confidenza, ti serve l\'intera cartella per poter eseguire il sito web, non solo `index.html`. Non toccare né spostare nulla del contenuto della cartella. Se stai conservando un backup del repository MyHotelWallet per il futuro, ti consigliamo di conservare soltanto il file ZIP in modo da assicurarti che i contenuti della cartella rimangano intatti. ',
HELP_5_Desc_9               : 'Dal momento che stiamo costantemente aggiornando MyHow.hotelbyte.foundation, ti consigliamo di aggiornare periodicamente la tua versione locale del repository. ',
...
HELP_8_Desc_1               : 'MyHotelWallet non è un portafoglio web. Non hai un login e niente viene mai salvato nei nostri server. È semplicemente un\'interfaccia che ti consente di interagire con la *blockchain*. ',
HELP_8_Desc_2               : 'Se MyHow.hotelbyte.foundation va giù, dovrai trovare un altro modo (come geth o Hotelbyte Wallet / Mist) per fare quello che facciamo noi. Ma non dovrai "tirare fuori" i tuoi ether da MyHotelWallet perché non si trovano in MyHotelWallet. Sono in qualunque portafoglio tu abbia generato tramite il nostro sito. ',
HELP_8_Desc_3               : 'Ora puoi importare direttamente e molto facilmente in geth / Hotelbyte Wallet / Mist la tua chiave privata non crittografata e i tuoi file in formato Ghbc/Mist (crittografati). Vedi la domanda n. 12 qui sotto. ',
HELP_8_Desc_4               : 'Inoltre, la probabilità che tiriamo giù MyHotelWallet è prossima allo zero. Non ci costa praticamente nulla mantenerlo dal momento che non stiamo memorizzando alcuna informazione. Se anche disattivassimo il dominio, è ancora, e sarà sempre, disponibile pubblicamente su [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puoi scaricare lo ZIP da lì ed eseguirlo in locale. ',

HELP_8CX_Title              : '8) Che succede se MyHotelWallet CX sparisce? ',
...
HELP_8CX_Desc_2             : 'Detto ciò, è **molto importante** che tu faccia un backup di tutte le informazioni relative a ogni nuovo portafoglio generato con MyHotelWallet CX. In questo modo se succede qualcosa a MyHotelWallet CX or al tuo computer avrai ancora tutte le informazioni necessarie ad accedere ai tuoi ether. Vedi la domanda n. 2a per come salvare i tuoi portafogli. ',
HELP_8CX_Desc_3             : 'Se per qualche ragione MyHotelWallet CX sparisce dal Chrome Store, puoi trovare i sorgenti su Github e caricare l\'estensione manualmente. Vedi la domanda n. 5 qui sopra. ',
...
HELP_12_Title               : '12) Come faccio a importare un portafoglio creato con MyHotelWallet in geth / Hotelbyte Wallet / Mist? ',
HELP_12_Desc_1              : 'Con un file JSON Ghbc/Mist generato da MyHotelWallet v2+.... ',
...
HELP_12_Desc_7              : 'Apri l\'applicazione Hotelbyte Wallet. ',
...
HELP_12_Desc_20             : 'Ti verrà chiesto di creare una nuova password. È la password che userai in geth / Hotelbyte Wallet / Mist ogni volta che invierai una transazione, quindi non dimenticarla. ',
HELP_12_Desc_21             : 'A importazione conclusa positivamente, cancella `niente_di_speciale_cancellami.txt` ',
HELP_12_Desc_22             : 'Alla prossima apertura dell\'applicazione Hotelbyte Wallet, il tuo conto sarà mostrato sotto "Accounts". ',
...
HELP_12_Desc_26             : 'Ti verrà chiesto di creare una nuova password. È la password che userai in geth / Hotelbyte Wallet / Mist ogni volta che invierai una transazione, quindi non dimenticarla. ',
HELP_12_Desc_27             : 'A importazione conclusa positivamente, cancella `niente_di_speciale_cancellami.txt` ',
HELP_12_Desc_28             : 'Alla prossima apertura dell\'applicazione Hotelbyte Wallet, il tuo conto sarà mostrato sotto "Accounts". ',
...
HELP_14_Title               : '14) Certi siti inizializzano il generatore di numeri casuali per la generazione della chiave privata tramite i movimenti del mouse. MyHow.hotelbyte.foundation non lo fa. La generazione di numeri casuali di MyHotelWallet è sicura? ',
HELP_14_Desc_1              : 'Sebbene usare i movimenti del mouse sia ingegnoso, e comprendiamo perché piaccia, la realtà è che window.crypto assicura maggiore entropia rispetto ai tuoi movimenti del mouse. Non che i movimenti del mouse siano insicuri, è solo che noi (e un sacco di altri critto-esperimenti) crediamo in window.crypto. Oltretutto, MyHow.hotelbyte.foundation può essere utilizzato su dispositivi touch. Qui c\'è una [conversazione fra un utente di reddit arrabbiato e Vitalik Buterin su movimenti del mouse contro window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) e qui c\'è [la specifica del w3 di window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_21_Desc_2              : 'Versione lunga in termini semplici: Hotelbyte si basa sulla [Crittografia a chiave pubblica](https://it.wikipedia.org/wiki/Crittografia_a_chiave_pubblica), nello specifico [Crittografia a curva ellittica](https://eprint.iacr.org/2013/734.pdf) (ECC) che è ampiamente utilizzata, non solo in Hotelbyte. La maggior parte dei server sono protetti tramite ECC. Anche Bitcoin la usa, oltre a SSH e TLS e a un sacco di altra roba. Le chiavi di Hotelbyte nello specifico sono di 256 bit, che sono più robuste di 128 bit e 192 bit, che sono anch\'esse ampiamente utilizzate e sono tuttora considerate sicure dagli esperti. ',
...
HELP_21_Desc_8              : 'Certo, tutto ciò assume che le chiavi siano generate in una maniera veramente casuale e con sufficiente entropia. Le chiavi generate qui soddisfano questi criteri, come anche Jaxx e Mist/geth. I portafogli Hotelbyte sono tutti piuttosto buoni. Le chiavi generate dai *brainwallet* non lo sono, dal momento che il cervello di una persona non è capace di creare un seme veramente casuale. Ci sono stati un numero di altri problemi relativi alla mancanza di entropia o a semi non generati in maniera veramente casuale nel mondo di Bitcoin, ma quella è un\'altra questione di cui non parleremo oggi. ',

HELP_SecCX_Title            : 'Sicurezza - MyHotelWallet CX ',
...
HELP_SecCX_Desc_6           : 'Se crittografassimo questi elementi dovresti inserire una password ogni volta in cui volessi vedere il saldo del tuo conto o i nomi dei portafogli. Se ciò ti preoccupa, ti consigliamo di usare MyHow.hotelbyte.foundation invece di questa estensione di Chrome. ',
...
HELP_Sec_Desc_4             : 'Controlla l\'URL -- Questo sito viene servito attraverso GitHub e puoi vederne il codice sorgente qui: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) su [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation). ',
