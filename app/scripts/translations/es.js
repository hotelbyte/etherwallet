...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo HBF diferente (ej. `HBF (Etherscan.io)` o `HBF (Infura.io)` o `HBF (MyHotelWallet)`) y comprueba de nuevo.',
...
/* Footer */
FOOTER_1                    : 'Una herramienta de código abierto JavaScript que se ejecuta en el lado del cliente, para generar carteras y enviar transacciones Hotelbyte. ',
...
TRANS_warning               : 'Si utilizas las funciones "Sólo HBF" o "Sólo ETC" estás enviando a través de un contrato. Algunos servicios tienen problemas aceptando estas transacciones. Leer más. ',
TRANS_advanced              : '+Avanzado: Añadir datos ',
TRANS_data                  : 'Datos ',
TRANS_gas                   : 'Límite de gas ',
TRANS_sendInfo              : 'Una transacción estándar que utiliza 21000 gas cuesta 0.000441 HBF. Utilizamos un precio de gas de 0.000000021 HBF, ligeramente por encima del mínimo, para asegurarnos de que se mina con rapidez. Nosotros no recibimos ninguna comisión por la transacción. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transacciones "Sólo HBF" y "Sólo ETC" ',
TRANSModal_Content_0        : 'Una nota sobre las distintas transacciones y servicios: ',
TRANSModal_Content_1        : '**HBF (transacción estándar): ** Esto genera una transacción predeterminada directamente de una dirección a otra. Utiliza gas predeterminado de 21000. Es probable que cualquier transacción de HBF enviada mediante este método se reproduzca (replay) en la cadena ETC. ',
TRANSModal_Content_2        : '**Sólo HBF: ** Esto envía a través del [contrato de protección contra replay de Timon Rapp (según recomienda VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) de modo que envías solamente en la cadena **HBF**. ',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con MyHotelWallet CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Esto te permite descargar múltiples versiones de claves privadas e imprimir de nuevo tu cartera en papel. Puede que te interese hacer esto para [importar tu cuenta en Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si quieres comprobar tu saldo, recomendamos utilizar un explorador de blockchain como [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde MyHow.hotelbyte.foundation. Para conectarte a cualquier nodo, puedes [descargar el repositorio de MyHotelWallet y ejecutarlo localmente](https://github.com/kvhnuke/etherwallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " por ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "¡Recibido! ", // HBF Received!
SWAP_progress_4             : "Enviando tu {{orderResult.output.currency}} ",
SWAP_progress_5             : "Pedido completado ",
SWAP_order_CTA              : "Por favor, envía ", // Please send 1 HBF...
SWAP_unlock                 : "Desbloquea tu cartera para enviar HBF o tokens directamente desde esta página. ",
...
ADD_Ledger_2                : 'Inicia la aplicacin Hotelbyte (o una aplicación de contrato) ',
...
ADD_Ledger_0a               : 'Volver a abrir MyHotelWallet en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir MyHotelWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Volver a abrir MyHotelWallet en una conexión segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Volver a abrir MyHotelWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ERROR_28                        :  '(error_29) **Necesitas tu archivo Keystore/JSON y la contraseña** (o clave privada) para acceder a esta cartera en el futuro. Por favor ¡guárdala y respáldala externamente! No hay modo de recuperar una cartera si no la guardas. Lee la [página de ayuda](https://myhow.hotelbyte.foundation/#help) para instrucciones. You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ', // 28
...
GHBF_Balance                    :  '(geth-01) Saldo insuficiente. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_Cheap                      :  '(geth-02) Precio de gas demasiado bajo para aceptación. Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right.',
GHBF_GasLimit                   :  '(geth-03) Sobrepasa el límite de gas del bloque. Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
GHBF_InsufficientFunds          :  '(geth-04) Fondos no suficientes para gas * precio + valor. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_IntrinsicGas               :  '(geth-05) Gas intrínseco demasiado bajo. Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again.',
GHBF_InvalidSender              :  '(geth-06) Remitente no válido. Invalid sender.',
GHBF_NegativeValue              :  '(geth-07) Valor negativo. Negative value.',
GHBF_Nonce                      :  "(geth-08) Nonce demasiado bajo. This TX's [nonce](https://myetherwallet.github.io/knowledge-base/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://myetherwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html).",
GHBF_NonExistentAccount         :  '(geth-09) La cuenta no existe o tiene un saldo insuficiente. Account does not exist or account balance too low',
...
HELP_2b_Title               : '2b) ¿Cómo almaceno con seguridad/sin conexión/en frío con MyHotelWallet? ',
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de MyHow.hotelbyte.foundation. ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando MyHotelWallet CX? ',
...
HELP_5_Title                : '5) ¿Cómo ejecuto MyHow.hotelbyte.foundation sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar MyHow.hotelbyte.foundation en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
HELP_5_Desc_7               : 'MyHow.hotelbyte.foundation is now running entirely on your computer. ',
HELP_5_Desc_8               : 'Por si no tienes costumbre, es necesario guardar la carpeta completa para ejecutar la página web, no solamente `index.html`. No modifiques ni muevas nada dentro de la carpeta. Si estás guardando una copia del repositorio MyHotelWallet para el futuro, recomendamos guardar únicamente el fichero ZIP para poder estar seguro de que el contenido permanezca intacto. ',
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando MyHow.hotelbyte.foundation, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_1               : 'MyHotelWallet no es una cartera web. No tienes un login y nunca se graba nada en nuestros servidores. You don\'t have a login and nothing ever gets saved to our servers. Simplemente es una interfaz que te permite interactuar con la cadena de bloques. ',
HELP_8_Desc_2               : 'Si MyHow.hotelbyte.foundation desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Hotelbyte Wallet / Mist). Pero no necesitarías retirar tus ether de MyHotelWallet porque no están en MyHotelWallet. Están en la cartera que hayas generado a través de nuestro sitio. ',
HELP_8_Desc_3               : 'Puedes importar tu clave privada sin cifrar y tus archivos en formato Ghbc/Mist (cifrados) directamente en geth / Hotelbyte Wallet / Mist con mucha facilidad actualmente. Ver más abajo la pregunta #12. ',
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos MyHotelWallet es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',

HELP_8CX_Title              : '8) ¿Qué ocurre si MyHotelWallet CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con MyHotelWallet CX. De este modo, si algo le ocurre a MyHotelWallet CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo MyHotelWallet CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_16_Desc_1              : 'You can use a blockchain explorer like [explorer.hotelbyte.org](https://explorer.hotelbyte.org). Paste your address into the search bar and it will pull up your account and transaction history. For example, here\'s what our [donation account](https://etherscan.io/address/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on etherscan.io ',
...
HELP_SecCX_Title            : 'Seguridad - MyHotelWallet CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices MyHow.hotelbyte.foundation en lugar de esta extensión de Chrome. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) a [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation). ',
