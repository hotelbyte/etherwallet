...
/* General */
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you HBFer or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Úgy is ismerheted ezt, mint "Számlaszám" vagy "Publikus Kulcs". Ez az amit a partnereidnek küldesz, hogy tudjanak HBF-et küldeni neked. Az oldalsó ikon egyszerű módja a saját címed felismerésének. ',
...
/* Footer */
FOOTER_1                    : 'Egy nyílt forrású, javascript-alapú, kliens-oldali eszköz Hotelbyte Tárcák létrehozására és tranzakicók végrehajtására. ',
...
TRANS_warning               : 'Ha a "Csak HBF" vagy a "Csak ETC" Funkciókat használod a küldés kontraktuson keresztül megy végbe. Néhány szolgáltatásnak problémái lehetnek az ilyen tranzakciók elfogadásával. Kattints és tudj meg többet. ',
TRANS_advanced              : '+Haladó: Több Adat ',
TRANS_data                  : 'Adat ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Egy standard tranzakció 21000 gas-t használ, ami 0.000441 HBF-be fog kerülni. Mi 0.000000021 HBF-nél (a minimálisnál) enyhén magasabb gas árat használunk, annak biztosítása érdekében, hogy gyorsan ki legyen bányászva. Tranazkciós költséget nem számolunk fel. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Csak HBF" és "Csak ETC" Tranzakciók ',
TRANSModal_Content_0        : 'Egy jegyzet a különféle tranzakciókról és szolgáltatásokról ',
TRANSModal_Content_1        : '**HBF (Standard Tranzakció): ** Egy alapértelmezett tranzakciót generál közvetlenül az egyik címről a másikra. A gas alapértéke 21000. Valószínűsíthető, hogy minden HBF, ami ezzel a módszerrel lesz elküldve, végbemegy az ETC láncon is. ',
TRANSModal_Content_2        : '**Csak HBF: **  Ez a tranzakciótípus [Timon Rapp replay protection/visszajátszás elleni védelem kontraktusán keresztül küld (ahogy azt Vitalik Buterin adjánlotta)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) tehát a küldés csak az **HBF** láncon megy végbe. ',
...
MYWAL_Content_3             : 'Ha használni akarod ezt a tárcát a MyHotelWallet CX-szel a jövőben, manuálisan újra hozzá kell majd adnod a privát kulcs/JSON-nal és jelszóval. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Ez lehetővé teszi számodra, hogy különböző változatú privát kulcsokat tölts le és újranyomtasd a papírtárcádat.  Ezt megteheted úgy, hogy [importálod a számládat a Ghbc/Mist-be](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Ha ellenőrizni akarod a számládat, azt ajánljuk, hogy használj blokklánc explorert mint az [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
ADD_Ledger_2                : 'Nyisd meg az Hotelbyte applikációt (vagy egy kontraktus applikációt) ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Érvénytelen küldő ',
GHBF_Nonce                  : 'a Nonce túl alacsony ',
GHBF_Cheap                  : 'A Gas ára túl alacsony az elfogadáshoz ',
GHBF_Balance                : 'Hiányos egyenleg ',
GHBF_NonExistentAccount     : 'A Számla nem létezik vagy az egyenleg túl alacsony ',
GHBF_InsufficientFunds      : 'Hiányos alap a gas-hoz * ár + érték ',
GHBF_IntrinsicGas           : 'Intrinsic gas túl alacsony ',
GHBF_GasLimit               : 'Meghaladja a blokk gas limitjét ',
GHBF_NegativeValue          : 'Negatív érték ',
...
TranslatorName_1            : '[belpheg](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f&value=1.0#send-transaction) · ',
TranslatorAddr_1            : '0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f ',
/* Translator 1             : email: zoltan.tapi@donamin.com */
TranslatorName_2            : '[bluqesh](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x4270A331d14CcdB6FB941f3f5De9Cf01607Bff9F&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : 'Az **Hotelbyte, MyHow.hotelbyte.foundation és MyHotelWallet CX, továbbá néhány, az oldal által használt JavaScript könyvtár aktív fejlesztés alatt állnak.** Az alapos tesztelés és a világszerte több tízezer sikeresen létrehozott tárca ellenére mindig fennáll az apró lehetőség arra, hogy valami váratlan esemény miatt elveszted az HBF-id. Ne fektess be annál többet, mint amit hajlandó lennél elveszítnei. Ha esetleg bármi ilyen történne, nagyon sajnáljuk, de **nem vagyunk a felősek az elvesztett Etherekért**. ',
HELP_Remind_Desc_2          : 'A MyHow.hotelbyte.foundation és a MyHotelWallet CX nem "web tárcák". Nem kell nálunk regisztrálnod, vagy ránk bízni az Ethereid megőrzésre. Semmilyen adat nem hagyja el a gépedet/böngésződet. Abban segítünk, hogy egyszerűen tudd az tárcáid látrehozni, lementeni és hozzájuk férni, és egyéb módon használni a blokkláncot. ',
...
HELP_0_Desc_1               : 'A MyHotelWallet-tel új tárcákat lehet létrehozni, hogy saját magadnál tudd tárolni az Ethert, és nem egy exchange-nél. Ez a folyamat teljesen a te gépeden történik, nem a mi szerverünkön, így amikor létrehozol egy új tárcát **a te felelősséged biztonságosan tárolni azt**. ',
...
HELP_2b_Title               : '2b) Hogyan tudom biztonságosan/offline/hidegen használni a MyHotelWallet-et? ',
...
HELP_3_Desc_3               : 'Menj a MyHow.hotelbyte.foundation-on a "Tárca adatainak megtekintése" oldalra. ',
...
HELP_5_Title                : '5) Hogyan lehet a MyHotelWallet-et offline/lokálisan használni? ',
HELP_5_Desc_1               : 'Futtahatod a MyHow.hotelbyte.foundation-ot a saját számítógépeden is, a GitHub szerverei nélkül. Így lehetőséged van teljesen offline generálni tárcákat, vagy Ethert küldeni az "Offline tranzakció" oldalról. ',
HELP_5_Desc_7               : 'A MyHow.hotelbyte.foundation most teljesen a te számítógépedről fut. ',
HELP_5_Desc_8               : 'Ha esetleg nem csináltál volna még ilyet: a teljes mappára szükséged van az oldal futtatásához, nem elég csak az "index.html" fájl. A mappában ne piszkálj / mozgass el semmit. Ha biztonsági másolatot szeretnél a MyHotelWallet repo-ról későbbre, akkor az eredeti zip fájl tárolását javasoljuk, így biztos lehetsz benne hogy a tartalma érintetlen marad. ',
HELP_5_Desc_9               : 'Mivel folyamatosan frissítjük a MyHow.hotelbyte.foundation-ot, ezért javasoljuk, hogy időközönként frissítsd a lementett repo-t is. ',
