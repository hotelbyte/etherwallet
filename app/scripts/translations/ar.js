...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different HBF node (e.g. `HBF (Etherscan.io)` or `HBF (Infura.io)` or `HBF (MyHotelWallet)`) and check again.',
...
GEN_Help_12                 : 'Use it to unlock your wallet via MyHotelWallet (or Mist, Ghbc, Parity and other wallet clients.) ',
...
GAS_LIMIT_Desc              : 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending HBF = `21000`. Sending Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> HBF here](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* General */
x_Access                    : 'Access ',
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you HBFer or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
...
/* Footer */
FOOTER_1                    : 'Free, open-source, client-side interface for generating Hotelbyte wallets &amp; more. Interact with the Hotelbyte blockchain easily &amp; securely. Double-check the URL ( myhow.hotelbyte.foundation ) before unlocking your wallet.',
...
sidebar_donation            : 'MyHotelWallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us? ',
sidebar_donate              : 'تبرع ',
sidebar_thanks              : 'شكرا!!! ',
...
ADD_Ledger_0a               : 'You must access MyHotelWallet via a secure(SSL / HTTPS) connection to connect.',
...
MYWAL_Content_3             : 'If you want to use this wallet with your MyHotelWallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
/* full sentence reads "You are about to send "10 HBF" to address "0x1234". Are you sure you want to do this? " */
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'A standard transaction using 21000 gas will cost 0.000441 HBF. We use a slightly-above-minimum gas price of 0.000000021 HBF to ensure it gets mined quickly. We do not take a transaction fee. ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via MyHow.hotelbyte.foundation. You can [download the MyHotelWallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'This allows you to download different versions of private keys and re-print your paper wallet. You may want to do this in order to [import your account into Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). If you want to check your balance, we recommend using a blockchain explorer like [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et de ré-imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
ADD_Ledger_2                : 'Ouvrez l\'application Hotelbyte (ou une application de contrat) ',
...
ADD_Ledger_0a               : 'Réouvrir MyHotelWallet sur une connexion sécurisée (SSL) ',
ADD_Ledger_0b               : 'Réouvrir MyHotelWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Connexion au TREZOR ',
ADD_Trezor_select           : 'Ceci est une _seed_ TREZOR ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Réouvrir MyHotelWallet sur une connexion sécurisée (SSL) ',
ADD_DigitalBitbox_0b        : 'Réouvrir MyHotelWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
GHBF_Balance                    :  '(geth-01) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_Cheap                      :  '(geth-02) Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right.',
GHBF_GasLimit                   :  '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
GHBF_InsufficientFunds          :  '(geth-04) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_IntrinsicGas               :  '(geth-05) Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again.',
GHBF_InvalidSender              :  '(geth-06) Invalid sender.',
GHBF_NegativeValue              :  '(geth-07) Negative value.',
...
GHBF_NonExistentAccount         :  '(geth-09) Account does not exist or account balance too low',
...
TranslatorName_1            : '[bstashio](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xD8FE791535Ad85D2b0E76e603443C1b39107729F&value=1.0#send-transaction) · ',
...
HELP_4_Desc_2               : 'Navigate to the "Send Hotelcoin & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send Hotelcoin & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send Hotelcoin & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Send Hotelcoin & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Send Hotelcoin & Tokens" page offline? ',
