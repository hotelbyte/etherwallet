...
MEW_Tagline                 : 'Hotelbyte кошелёк на javascript с открытым исходным кодом ',
CX_Tagline                  : 'Hotelbyte кошелёк на javascript с открытым исходным кодом в виде расширения для браузера Chrome ',

/* Footer */
FOOTER_1                    : 'Написанный на javascript инструмент с открытым исходным кодом для создания Hotelbyte кошельков и выполнения транзакций. ',
FOOTER_1b                   : 'Авторы: ',
...
TRANS_warning               : 'Если Вы используете функции "только HBF" или "только ETC", перевод будет выполнен с помощью контракта. У некоторых сервисов могут возникнуть проблемы с приёмом таких переводов. Уточните этот вопрос. ',
...
TRANSModal_Title            : 'Транзакции вида "только HBF" и "только ETC" ',
TRANSModal_Content_0        : 'О видах транзакций и сервисах: ',
TRANSModal_Content_1        : '**Эфир (ether, обычная транзакция): ** Выполняет обычный перевод напрямую с одного адреса на другой. Используется стандартное количесвто газа: 21000. В большинстве случаев, перевод HBF, выполненный этим способом, можно будет продублировать для ETC. ',
TRANSModal_Content_2        : '**Только HBF: ** Выполняет перевод через [контракт Тимона Раппа, защищающий от дублирования переводов (рекомендован ВБ)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), поэтому перевод будет выполнен только в **HBF**. ',
...
NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы MyHow.hotelbyte.foundation мог с ним работать. Вы можете [скачать репозиторий MyHotelWallet & и запустить его локально](https://github.com/kvhnuke/etherwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Имя узла',
NODE_Port                   : 'Порт узла',
...
SWAP_init_2                 : " на ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Получено! ", // HBF Received!
SWAP_progress_4             : "Отправляем ваши {{orderResult.output.currency}} ",
SWAP_progress_5             : "Заявка выполнена ",
SWAP_order_CTA              : "Пожалуйста, отправьте ", // Please send 1 HBF...
SWAP_unlock                 : "Отоприте ваш кошелёк для отправки HBF или Tokens непосредственно с этой страницы. ",
...
ADD_Ledger_2                : 'Запустите приложение Hotelbyte (или приложение контракта) ',
...
ADD_Ledger_0a               : 'Перезапустите MyHotelWallet через безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите MyHotelWallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Перезапустите MyHotelWallet через безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите MyHotelWallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Неверный адрес отправителя ',
GHBF_Nonce                  : 'Номер перевода (nonce) слишком мал ',
GHBF_Cheap                  : 'Цена газа слишком низкая ',
GHBF_Balance                : 'Баланс недостаточен ',
GHBF_NonExistentAccount     : 'Счёт не существует или баланс счёта слишком мал ',
GHBF_InsufficientFunds      : 'Недостаточно средств для ГАЗ * ЦЕНА + СУММА ',
GHBF_IntrinsicGas           : 'Недостаточно газа для выполнения транзакции ',
GHBF_GasLimit               : 'Превышен лимит газа на блок ',
GHBF_NegativeValue          : 'Отрицательная сумма ',
...
TranslatorName_1            : '[Михаил Владимиров](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x6ff323e36bfdb20502b23780695f4e77e36cde95&value=1.0#send-transaction) ',
