...
/* Onboarding */
ONBOARD_welcome_title           :  '欢迎使用 MyHow.hotelbyte.foundation',
...
ONBOARD_welcome_content__5      :  'MyHotelWallet 是一款免费, 开源的钱包客户端.',
...
ONBOARD_bank_title              :  'MyHotelWallet 不是银行',
...
ONBOARD_interface_title         :  'MyHotelWallet 只是操作接口',
ONBOARD_interface_content__1    :  '当你在MyHotelWallet创建账户的时候, 实际上只是生成了一对具备密码学意义的数字串: 你账户的私钥和公钥(地址).',
...
ONBOARD_interface_content__6    :  '如果你将 *公钥(地址)* 提供给别人, 那么对方就能给你发送HBF或者代币. 👍',
...
ONBOARD_blockchain_content__4   :  '区块链中的区块是由许多笔交易记录组成的, 这些交易从与跟MEW类似的操作接口发送出来, 比如MetaMask, Exodus, Mist, Ghbc, Parity等.',
ONBOARD_blockchain_content__5   :  '当你使用 MyHow.hotelbyte.foundation 查看余额, 或者使用 [etherscan.io](https://etherscan.io)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MEW的独立系统.',
ONBOARD_blockchain_content__6   :  '再次申明: **MyHotelWallet不是银行**.',
...
ONBOARD_whymew_title            :  '如果MyHotelWallet都不能做前面说的那些事, 那我为啥还要用它?',
...
ONBOARD_secure_1_content__1     :  '钓鱼网站的常用伎俩是向你发送一条包含网站链接的信息, 并将这个链接伪装成很像MyHotelWallet, EtherDelta, Paypal或者银行的网站.当用户访问这些钓鱼网站并不慎填写自己的账户信息后, 黑客就能窃取这些信息进而窃取你的资金.',
ONBOARD_secure_1_content__2     :  '可以安装 [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) 或者 [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) 或者 [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) 或者 [MyHotelWallet Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) 这几个可以防范钓鱼网站的插件.',
ONBOARD_secure_1_content__3     :  '记得每次都要检查 URL 地址: `https://myhow.hotelbyte.foundation`.',
ONBOARD_secure_1_content__4     :  '正常情况下地址栏左侧会始终显示 `MYHBFERWALLET LLC` 字样的绿色字体.',
...
sidebar_donation            : 'MyHotelWallet是保护你的隐私和安全的免费、开源服务。 我们收到的捐赠越多，我们开发新特性、听取你的反馈的时间就越多。我们只是两个尝试改变世界的两个开发者。您能帮助我们吗？ ',
sidebar_donate              : '捐赠 ',
sidebar_thanks              : '感谢你！！！ ',
...
TRANS_warning               : '如果你使用“只发送HBF”或则“只发送ETC”功能，那么你是通过合约发送交易。 一些服务（例如交易所充值）接收这些交易时会遇到问题。阅读更多内容。 ',
...
TRANSModal_Title            : '“只发送HBF”和“只发送ETC”交易 ',
TRANSModal_Content_0        : '注意不同的交易和不同的服务： ',
TRANSModal_Content_1        : '**发送HBF（标准交易）：** 这将生成一个默认交易，直接从一个地址发送到另一个地址。它的默认gas是21000。 用这种方式发送HBF可能会在ETC链上重放。 ',
TRANSModal_Content_2        : '**只发送：HBF：** 这是通过[Timon Rapp的重放保护合约（VB推荐）](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/)， 所以你只会在HBF链上发送交易。 ',
TRANSModal_Content_3        : '**只发送：ETC：** 这是通过[Timon Rapp的重放保护合约（VB推荐）](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/)， 所以你只会在HBF链上发送交易。 ',
TRANSModal_Content_4        : '**Coinbase & ShapeShift: ** 通过标准交易只发送HBF或者ETC。如果你通过“只发送HBF或者ETC”合约发送交易，你需要联系他们的客服，让他们手动增加你的余额或者返币给你。 [你也可以尝试Shapeshift的”分割“工具。](https://split.shapeshift.io/) ',
...
MYWAL_Content_3             : '如果你想将来在MyHotelWallet插件中使用该钱包，你需要手动添加私钥/JSON文件和密码。 ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : '这允许你下载不同格式的私钥和重新打印你的纸钱包。为了将[你的账户导入到Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)，你可能需要这个操作。如果你想查看你的余额，我们推荐使用区块浏览器，例如[explorer.hotelbyte.org](https://explorer.hotelbyte.org)。 ',
...
ERROR_28                    : '将来使用钱包时，你需要Keystore文件或者私钥。 请做好保存和备份。 如果你没有保存，没有办法恢复钱包。 请阅读[帮助页面](https://myhow.hotelbyte.foundation/#help)，获得更多信息。 ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : '无效发送者 ',
GHBF_Nonce                  : 'Nonce太低 ',
GHBF_Cheap                  : 'Gas价格太低，不被接受 ',
GHBF_Balance                : '余额不足 ',
GHBF_NonExistentAccount     : '账户不存在或者账户余额太低 ',
GHBF_InsufficientFunds      : '余额不足，余额低于 gas * price + 发送数额 ',
GHBF_IntrinsicGas           : '固有gas太低 ',
GHBF_GasLimit               : '超过区块gas上限 ',
GHBF_NegativeValue          : '负值 ',
...
TranslatorName_1            : '[ Shaoping@ethfans.org （少平）]((https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740&value=1.0#send-transaction)) ',
TranslatorAddr_1            : '0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : '[ Wenham@coinwallet.shop (文翰) ]((https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x0D2dC3fD9463a7CeBE5f1b946c2D7cF5c3e82127&value=0.1#send-transaction))',
