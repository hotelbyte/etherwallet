...
tx_notFound_4               : 'Utilitza el menú desplegable a la part superior dreta i selecciona un node HBF diferent (p. Ex. `HBF (Etherscan.io)` o `HBF (Infura.io)` o `HBF (MyHotelWallet)`)  i torna-ho a comprovar.',
...
tx_FoundOnChain_3           : '**Si no veus cap error, la teva transacció s\'ha enviat amb èxit.** El teu HBF o Tokens són on els has enviat. Si no pots veure aquest HBF o Tokens a la teva cartera / compte de bescanvi, i han passat més de 24 hores des de l\'enviament, si us plau [contacta amb aquest servei](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envia *l\'enllaç* de la teva transacció si demana amablement que investiguin.',
...
GEN_Help_12                 : 'Utilitza\'l per desbloquejar la teva cartera amb MyHotelWallet (o Mist, Ghbc, Parity i altres clients de carteres.) ',
...
GAS_LIMIT_Desc              : 'El límit de gas és la quantitat de gas a enviar amb la teva TX. `TX fee` = preu del gas * límit de gas; i es paga als miners per incloure la teva TX a un block. Incrementat aquest nombre no farà que la teva TX sigui minada més ràpidament. Enviant HBF = `21000`. Enviant Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'La comissió per la TX es paga als miners per incloure la teva TX en un block. És el `límit de gas` * `preu del gas`. [Pots convertir GWEI -> HBF aquí](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Eina gratuïta, de codi obert que s\'executa en el client per generar carteres d\'Hotelbyte i més. Interactua fàcilment amb la blockchain d\'Hotelbyte de manera fàcil i segura. Comprova l\'URL (.com) abans de desbloquejar la teva cartera.',
FOOTER_1b                   : 'Creat per ',
...
sidebar_donation            : 'MyHotelWallet és un servei lliure i de codi obert, dedicat a la teva privacitat i seguretat. Com més donacions rebem, més temps invertim creant noves funcions, escoltant els vostres comentaris i oferint-vos el que voleu. Només som dues persones que intentem canviar el món. Ens ajudes? ',
sidebar_donate              : 'Dóna ',
...
ADD_Ledger_2                : 'Obre l\'aplicació d\'Hotelbyte (o una aplicació de contracte) ',
...
ADD_Ledger_0a               : 'Has d\'accedir a MyHotelWallet utilitzant una connexió segura (SSL / HTTPS). ',
ADD_Ledger_0b               : 'Torna a obrir MyHotelWallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Torna a obrir MyHotelWallet utilitzant una connexió segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Torna a obrir MyHotelWallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Si vols utilitzar aquesta cartera amb MyHotelWallet CX en el futur, hauràs de tornar a afegir-la manualment utilitzant la clau privada/JSON i contrasenya. ',
...
TRANS_sendInfo              : 'Una transacció estàndard utilitzant 21000 gas costarà 0.000441 HBF. Utilitzem un preu una mica per sobre del mínim de 0.000000021 HBF per assegurar que es mina ràpidament. No ens quedem cap comissió per la transacció. ',
...
NODE_Warning                : 'El teu node ha de ser HTTPS per tal de poder-t\'hi connectar utilitzant MyHow.hotelbyte.foundation. Pots [descarregar-te el repo de MyHotelWallet i executar-lo localment](https://github.com/kvhnuke/etherwallet/releases/latest) per connectar-te a qualsevol node. O, obtén un certificat SSSL gratuït amb [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " per ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Rebut! ", // HBF Received!
SWAP_progress_4             : "Enviant el teu {{orderResult.output.currency}} ",
SWAP_progress_5             : "Comanda completa ",
SWAP_order_CTA              : "Si us plau envia ", // Please send 1 HBF...
SWAP_unlock                 : "Desbloqueja la teva cartera per enviar HBF o Tokens directament des d\'aquesta pàgina ",
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Això et permet descarregar diferents versions de les claus privades i tornar a imprimir la teva cartera de paper. És possible que vulguis fer això per [importar el teu compte a Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vols comprovar el teu saldo, recomanem utilitzar un explorador de la blockchain com [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
GHBF_Balance                    :  '(geth-01) Saldo insuficient. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_Cheap                      :  '(geth-02) El preu del gas és massa petit per ser acceptat. Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right.',
GHBF_GasLimit                   :  '(geth-03) Excedeix del block gas límit. Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
GHBF_InsufficientFunds          :  '(geth-04) Saldo insuficient per gas * preu + valor. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_IntrinsicGas               :  '(geth-05) Gas intrínsec massa baix. Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again.',
GHBF_InvalidSender              :  '(geth-06) Emissor no vàlid. Invalid sender.',
GHBF_NegativeValue              :  '(geth-07) Valor negatiu. Negative value.',
GHBF_Nonce                      :  "(geth-08) Nonce massa baix. This TX's [nonce](https://myetherwallet.github.io/knowledge-base/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://myetherwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html).",
GHBF_NonExistentAccount         :  '(geth-09) El compte no existeix o el saldo és massa baix. Account does not exist or account balance too low',
