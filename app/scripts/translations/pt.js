...
X_HelpfulLinks_4                :  'Migrando para/de MyHotelWallet',
...
/* Footer */
FOOTER_1                    : 'Uma fonte aberta, javascript, ferramenta do client-side para gerar Carteiras Hotelbyte & envio de transações. ',
...
sidebar_donation            : 'MyHotelWallet é grátis, um serviço de fonte aberta dedicado a sua privacidade e segurança. Quanto mais doações nós recebermos, mais podemos gastar criando novidade, ouvindo seu feedback, e entregando o que você deseja. Somos apenas duas pessoas tentando mudar o mundo. Ajude-nos? ',
sidebar_donate              : 'De ',
...
/* Send Transaction */
TRANS_desc                  : '',
TRANS_warning               : 'Se você estiver usando somente "HBF" ou "ETC" Funções que você está enviando através de um contrato. Alguns serviços têm problemas para aceitar essas transações. Leia mais. ',
TRANS_advanced              : '+Avançado: Adicionar dados ',
TRANS_data                  : 'Dados ',
TRANS_gas                   : 'Gás Limit ',
TRANS_sendInfo              : 'Uma transação padrão usando 21000 gás irá custar 0.000441 HBF. Nós usamos um preço ligeiramente acima do mínima de gás de 0,000000021 HBF para garantir que ele seja minado rapidamente. Nós não recebemos nenhuma taxa de transação. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Só HBF" e "Só ETC" Transações ',
TRANSModal_Content_0        : 'Uma nota sobre diferentes transações e diferentes serviços: ',
TRANSModal_Content_1        : '**HBF (Transação Padrão): ** Isso gera uma transação padrão diretamente de um endereço para outro. Tem um gás padrão de 21000. É provável que qualquer HBF enviados através deste método serão repetidos para a cadeia ETC.. ',
TRANSModal_Content_2        : '**Só HBF: ** Isso envia via [Timon Rapp\'s contrato de proteção de repetição (como recomendado pelo VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) para que você só envie na cadeia **HBF**. ',
...
MYWAL_Content_3             : 'Se pretender utilizar esta carteira com o MyHotelWallet CX no futuro, terá de voltar a adicioná-la manualmente utilizando a chave privada/JSON e a palavra-passe. ',
...
ADD_Ledger_2                : 'Abra a aplicação Hotelbyte (ou uma aplicação de contrato) ',
...
ADD_Ledger_0a               : 'Re-abra MyHotelWallet em uma conexão (SSL) segura ',
ADD_Ledger_0b               : 'Re-abra MyHotelWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Re-abra MyHotelWallet em uma conexão (SSL) segura ',
ADD_DigitalBitbox_0b        : 'Re-abra MyHotelWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
ERROR_28                    : '**Você precisa do seu arquivo de armazenamento de chaves & senha** (ou Chave Privada) para acessar essa carteira no futuro. Por favor, salve e armazene ela externamente! Não há como recuperar uma carteira se você não salvar isso. Leia a [página de ajuda](https://myhow.hotelbyte.foundation/#help) para instruções. ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Invalid sender ',
...
GHBF_GasLimit               : 'Exceeds block gas limit ',
GHBF_NegativeValue          : 'Negative value ',
...
TranslatorName_1            : '[ Pedro "ShooterXD" Vieira ](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x24eB7d82166361A8B69adE6FEA187Cb00FD7c7E1&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
