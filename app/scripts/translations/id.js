...
X_HelpfulLinks_4                :  'Migrasi ke/dari MyHotelWallet',
...
ENS_Helper_4                    :  'Tentukan jumlah maksimum HBF yang bersedia Anda bayar untuk nama tersebut (<u>Bid Amount</u> Anda). Pastikan akun memiliki cukup dana untuk membayar tawaran Anda + 0.01 HBF untuk gas.',
...
ENS_Helper_16                   :  'Pemenang akan mendapat pengembalian selisih antara tawaran mereka dan tawaran tertinggi berikutnya. Jika Anda adalah satu-satunya penawar, akan mendapat pengembalian penuh dipotong 0,01 HBF.',
...
ENS_Helper_21                   :  'Mengumumkan Tanggal Peluncuran kembali Hotelbyte Name Service!',
...
EOS_06                          :  'Buka halaman Send Hotelcoin & Tokens',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di MyHow.hotelbyte.foundation',
...
ONBOARD_welcome_content__5      :  'MyHotelWallet adalah antarmuka sisi klien berbasis open source yang gratis.',
...
ONBOARD_bank_title              :  'MyHotelWallet bukan Bank',
...
ONBOARD_interface_title         :  'MyHotelWallet adalah sebuah antarmuka',
ONBOARD_interface_content__1    :  'Saat membuat akun di MyHotelWallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_interface_content__6    :  'Jika Anda mengirim *kunci publik (alamat)* kepada seseorang, mereka dapat mengirimkan HBF atau token. 👍',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari MyHotelWallet, MetaMask, Exodus, Mist, Ghbc, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di MyHow.hotelbyte.foundation atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
...
ONBOARD_whymew_title            :  'Jika MyHotelWallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti MyHotelWallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
ONBOARD_secure_1_content__2     :  'Pasang [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) atau [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) atau [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) atau [MyHotelWallet Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) untuk memblokir situs web jahat.',
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://myhow.hotelbyte.foundation`.',
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `MYHBFERWALLET LLC` dalam warna hijau.',
...
ONBOARD_final_content__4        :  'Cara Menjalankan MyHOW Offline / Lokal',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node HBF lainnya (e.g. `HBF (Etherscan.io)` atau `HBF (Infura.io)` atau `HBF (MyHotelWallet)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui MyHotelWallet (atau Mist, Ghbc, Parity maupun perangkat lunak dompet lainnya.) ',
...
GAS_LIMIT_Desc              : 'Batas Gas (Gas limit) adalah jumlah gas untuk dikirim bersama TX Anda.  `Biaya TX = harga gas * gas limit` & dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Menaikkan angka ini tidak mempercepat TX Anda untuk ditambang. Pengiriman HBF = `21000`. Pengiriman Token = ~`200000`.',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> HBF](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Client-side tool open source berbasis javascript untuk membuat Dompet dan transaksi Hotelbyte. ',
FOOTER_1b                   : 'Oleh ',
...
ADD_Ledger_2                : 'Buka Aplikasi Hotelbyte (atau aplikasi kontrak) ',
...
ADD_Ledger_0a               : 'Buka kembali MyHotelWallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali MyHotelWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali MyHotelWallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali MyHotelWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
TRANS_warning               : 'Penggunaan fitur "Hanya HBF" atau "Hanya ETC" memakai pengiriman melalui Kontrak. Beberapa layanan tidak menerima transaksi jenis ini. Baca lebih lanjut. ',
TRANS_advanced              : '+Advanced: Tambah Data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Transaksi standar menggunakan 21000 gas membutuhkan 0.000441 HBF. Kami memakai harga gas sedikit-diatas-harga-gas-minimum senilai 0.000000021 HBF untuk mempercepat. Kami tidak mengambil biaya atas transaksi. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transaksi "Hanya HBF" dan "Hanya ETC" ',
TRANSModal_Content_0        : 'Catatan terkait jenis transaksi dan layanan: ',
TRANSModal_Content_1        : '**HBF (Transaksi Standar): ** Transaksi default ini melakukan pengiriman langsung dari alamat pengirim ke alamat tujuan. Nilai Gas 21000. Besar kemungkinan HBF yang dikirim dengan metode ini akan di "replay" di rantai ETC. ',
TRANSModal_Content_2        : '**Hanya HBF: ** Pengiriman melalui [kontrak penangkal "replay" oleh Timon Rapp (direkomendasikan oleh VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) sehingga hanya dilaksanakan di rantai **HBF** saja. ',
...
TRANSModal_Content_4        : '**Coinbase & ShapeShift: ** Hanya melakukan pengiriman melalui Transaksi Standar saja. Jika Anda mengirim menggunakan "Hanya HBF" atau "Hanya ETC", hubungi layanan konsumen mereka untuk menambahkan saldo Anda secara manual atau membatalkan transaksinya. [Bisa juga dicoba fasilitas "split" dari Shapeshift.](https://split.shapeshift.io/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan MyHotelWallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Memungkinkan Anda untuk mencetak Dompet Kertas dari berbagai format atau versi Kunci Privat. Hal ini diperlukan pada saat anda ingin [mengimpor akun Anda ke Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Jika Anda hanya ingin pengecekan saldo, pakailah salah satu layanan blockchain explorer seperti [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui MyHow.hotelbyte.foundation. Anda dapat [mengunduh MyHotelWallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
SWAP_init_2                 : " menjadi ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Diterima! ", // HBF Received!
SWAP_progress_4             : "Mengirim {{orderResult.output.currency}} ",
SWAP_progress_5             : "Perintah Selesai ",
SWAP_order_CTA              : "Kirimkan ", // Please send 1 HBF...
SWAP_unlock                 : "Unlock wallet Anda untuk mengirim HBF atau Token langsung dari halaman ini. ",
...
ERROR_17                    : 'Dana tidak mencukupi. Akun yang dipakai untuk mengirim tidak memiliki dana yang cukup. Minimal harus ada **0.01 HBF** di akun untuk menutup biaya gas. Tambahkan ether dan coba lagi. ',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://myhow.hotelbyte.foundation/#help). ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Pengirim tidak valid ',
GHBF_Nonce                  : 'Nonce terlalu rendah ',
GHBF_Cheap                  : 'Harga Gas terlalu kecil untuk dapat diterima ',
GHBF_Balance                : 'Saldo tidak mencukupi ',
GHBF_NonExistentAccount     : 'Akun tidak ditemukan atau saldo terlalu rendah ',
GHBF_InsufficientFunds      : 'Tidak cukup saldo untuk gas * harga + nilai ',
GHBF_IntrinsicGas           : 'Gas intrinsik terlalu rendah ',
GHBF_GasLimit               : 'Melebihi limit blok gas ',
GHBF_NegativeValue          : 'Nilai negatif ',
...
TranslatorName_1            : '[Yos Ginting](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_2b_Title               : '2b) Bagaimana cara penyimpanan yang aman / offline / cold storage menggunakan MyHotelWallet? ',
...
HELP_3_Desc_3               : 'Buka laman MyHow.hotelbyte.foundation bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan MyHotelWallet CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan MyHow.hotelbyte.foundation secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan MyHow.hotelbyte.foundation secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'MyHow.hotelbyte.foundation sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari MyHotelWallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui MyHow.hotelbyte.foundation, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_1               : 'MyHotelWallet bukan dompet web. Anda tidak memiliki login dan tidak ada yang bisa disimpan ke server kami. Ini hanyalah sebuah antarmuka yang memungkinkan Anda berinteraksi dengan blockchain. ',
HELP_8_Desc_2               : 'Jika situs MyHow.hotelbyte.foundation tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Hotelbyte Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari MyHow.hotelbyte.foundation karena Ether Anda tidak disimpan di MyHow.hotelbyte.foundation. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
HELP_8_Desc_3               : 'Sekarang Anda dapat mengimpor Kunci Privat yang tidak dienkripsi dan file dalam format Ghbc/Mist (terenkripsi) langsung ke geth/ Hotelbyte Wallet/Mist dengan sangat mudah. Lihat pertanyaan #12 di bawah ini. ',
HELP_8_Desc_4               : 'Lebih dari itu, kemungkinan kita menghentikan layanan MyHotelWallet sangat kecil. Hampir tidak ada biaya dari penyelenggaraan layanan ini karena kami tidak menyimpan data apapun. Kalaupun sampai kami menghentikan layanan, semua file ini akan selalu akan tersedia untuk umum di [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Anda bisa mendownload file ZIP-nya disana dan menjalankannya secara lokal. ',

HELP_8CX_Title              : '8) Apa yang terjadi jika MyHotelWallet CX tidak beredar lagi? ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan MyHotelWallet CX. Dengan begitu, jika terjadi sesuatu pada MyHotelWallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya MyHotelWallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan MyHotelWallet ke dalam geth / Hotelbyte Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Ghbc/Mist JSON yang dibuat dari MyHotelWallet v2+.... ',
...
HELP_12_Desc_6              : 'Temukan bagian "Download JSON file - Ghbc/Mist Format (terenkripsi)". Tekan tombol "Download" di bawahnya. Anda akan dapatkan file keystore-nya. ',
HELP_12_Desc_7              : 'Buka aplikasi Hotelbyte Wallet. ',
...
HELP_12_Desc_20             : 'Anda akan diminta untuk membuat password baru. Ini adalah password yang akan Anda gunakan di geth/Hotelbyte Wallet/Mist setiap kali Anda akan mengirim transaksi, mohon diingat dan jangan sampai lupa. ',
...
HELP_12_Desc_26             : 'Anda akan diminta untuk membuat password baru. Ini adalah password yang akan Anda gunakan di geth/Hotelbyte Wallet/Mist setiap kali Anda akan mengirim transaksi, mohon diingat dan jangan sampai lupa. ',
...
HELP_16_Desc_1              : 'Anda bisa menggunakan eksplorer blockchain seperti [explorer.hotelbyte.org](https://explorer.hotelbyte.org). Paste alamat Anda ke dalam search bar dan riwayat transaksi Anda akan ditampilkan. Contohnya, [akun donasi kami](https://etherscan.io/address/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) dilihat di etherscan.io ',
...
HELP_21_Desc_2              : 'Jawaban panjang versi ELI5: Hotelbyte dibuat berdasarkan [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), dan lebih spesifiknya [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf) yang sangat banyak digunakan, tidak hanya di Hotelbyte. Sebagian besar server dilindungi melalui ECC. Bitcoin juga menggunakannya, begitu pula SSH dan TLS dan banyak lagi lainnya. Secara spesifik, Hotelbyte memakai kunci 256-bit, yang lebih kuat dari 128-bit dan 192-bit, yang juga banyak penggunanya dan masih dianggap aman oleh para ahli. ',
...
HELP_SecCX_Title            : 'Keamanan - MyHotelWallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan MyHow.hotelbyte.foundation, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation). ',
