...
tx_notFound_4               : 'กรุณาใช้กล่อง dropdown ที่มุมขวาบน & เลือก HBF Node อื่น (เช่น `HBF (Etherscan.io)` หรือ `HBF (Infura.io)` หรือ `HBF (MyHotelWallet)`) และตรวจสอบอีกครั้ง',
...
GEN_Help_12                 : 'ใช้เพื่อปลดล็อกกระเป๋าของคุณผ่าน MyHotelWallet (หรือ Mist, Ghbc, Parity หรือโปรแกรมกระเป๋าอื่นๆ) ',
...
GAS_LIMIT_Desc              : 'จำนวนจำกัดแก๊ส คือปริมาณของแก๊สที่จะส่งไปกับธุรกรรม (TX) ของคุณ `ค่าธรรมเนียม TX = ราคาแก๊ส * จำนวนจำกัดแก๊ส และจะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค การเพิ่มจำนวนนี้จะไม่ทำให้ TX ของคุณถูกขุดสำเร็จไวขึ้น การส่ง HBF = `21000` หากส่ง Token = ~`200000`',
...
TXFEE_Desc                  : 'ค่าธรรมเนียมธุรกรรม (TX) จะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค มีค่าเท่ากับ `จำนวนจำกัดแก๊ส` * `ราคาแก๊ส` [คุณสามารถแปลง GWEI -> HBF ได้ที่นี่](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'ฟรี, โอเพ่นซอร์ส, อินเตอร์เฟสฝั่งไคลเอนต์สำหรับสร้างกระเป๋า Hotelbyte &amp; อื่นๆอีกมากมาย และทำธุรกรรมผ่านบล็อคเชนของ Hotelbyte ได้อย่างง่ายดาย &amp; ปลอดภัย อย่าลืมตรวจสอบ URL ( myetherwallet.com ) ทุกครั้งก่อนเข้าใช้กระเป๋าของคุณ',
...
ADD_Ledger_2                : 'เปิด Hotelbyte application (หรือ contract application) ',
...
ADD_Ledger_0a               : 'คุณต้องเข้าใช้ MyHotelWallet ผ่านทางการเชื่อมต่อที่ปลอดภัย (SSL / HTTPS) ถึงจะสามารถเชื่อมต่อได้ ',
ADD_Ledger_0b               : 'เปิด MyHotelWallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'เปิด MyHotelWallet อีกครั้งผ่านการเชื่อมต่อที่ปลอดภัย (SSL) ',
ADD_DigitalBitbox_0b        : 'เปิด MyHotelWallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'ถ้าหากคุณต้องการจะใช้กระเป๋านี้ร่วมกับ MyHotelWallet CX ในอนาคต คุณจำเป็นจะต้องเพิ่มกระเป๋าใหม่อีกครั้งด้วย private key/JSON และรหัสผ่าน ',
...
TRANS_sendInfo              : 'ธุรกรรมโดยทั่วไปจะใช้ค่าแก๊สจำนวน 21000 แก๊ส ซึ่งมีมูลค่าเท่ากับ 0.000441 HBF เราจะใช้ค่าแก๊สที่สูงกว่าทั่วไปอีก 0.000000021 HBF เพื่อทำให้แน่ใจว่าธุกรรมถูกขุดอย่างรวดเร็ว เราไม่ได้เป็นผู้รับค่าธรรมเนียมในการทำธุรกรรม ',
...
NODE_Warning                : 'Node ของคุณจะต้องเป็น HTTPS เพื่อที่จะเชื่อมต่อกับ MyHow.hotelbyte.foundation คุณสามารถ [ดาวน์โหลดซอร์สโค้ดจาก MyHotelWallet repo & รันบนเครื่องคอมพิวเตอร์ของคุณ](https://github.com/kvhnuke/etherwallet/releases/latest) เพื่อเชื่อมต่อกับ Node ใดๆ หรือสร้างใบรับรอง SSL ผ่าน [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'ชื่อ Node',
...
SWAP_init_2                 : " ของฉันด้วย ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "ได้รับแล้ว! ", // HBF Received!
SWAP_progress_4             : "กำลังส่ง {{orderResult.output.currency}} ",
SWAP_progress_5             : "คำสั่งสำเร็จ ",
SWAP_order_CTA              : "กรุณาส่ง ", // Please send 1 HBF...
SWAP_unlock                 : "ปลดล็อกกระเป๋าของคุณเพื่อส่ง HBF หรือ Token ได้โดยตรงจากหน้านี้ ",
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'หน้านี้ทำให้คุณสามารถดาวน์โหลดกุญแจส่วนตัว (Private key) ของคุณได้ในรูปแบบต่างๆ และสั่งพิมพ์กระเป๋ากระดาษของคุณใหม่ ซึ่งคุณอาจจะต้องใช้มันเพื่อ [นำเข้าบัญชีของคุณไปยัง Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/) แต่หากคุณแค่ต้องการจะตรวจสอบยอดคงเหลือของคุณ เราแนะนำให้ใชัเว็บ blockchain explorer เช่น [explorer.hotelbyte.org](https://explorer.hotelbyte.org) ',
...
ERROR_17                    : 'มียอดคงเหลือไม่พอในบัญชีที่คุณกำลังจะส่งออก ถ้าหากคุณกำลังจะส่ง Token คุณจะต้องมีอย่างน้อย 0.01 HBF อยู่ในบัญชีของคุณ เพื่อใช้เป็นค่าแก๊ส ', // 17
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'ผู้ส่งไม่ถูกต้อง ',
GHBF_Nonce                  : 'ค่า Nonce ต่ำเกินไป ',
GHBF_Cheap                  : 'ราคาแก๊สต่ำเกินกว่าจะรับได้ ',
GHBF_Balance                : 'ยอดคงเหลือไม่เพียงพอ ',
GHBF_NonExistentAccount     : 'บัญชีนี้ไม่มีอยู่จริง หรือยอดคงเหลือในบัญชีไม่เพียงพอ ',
GHBF_InsufficientFunds      : 'ยอดมูลค่าไม่เพียงพอสำหรับ จำนวนแก๊ส * ราคาแก๊ส + จำนวนมูลค่า ',
GHBF_IntrinsicGas           : 'จำนวนแก๊สต่ำเกินไป ',
GHBF_GasLimit               : 'เกินจำนวนจำกัดของแก๊ส ',
GHBF_NegativeValue          : 'จำนวนติดลบ ',
...
TranslatorName_1            : '[Tianissimo (Suteepat)](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x8d0a185C16ADE28bf69Cb38c5e3df605360df40e&value=1.0#send-transaction) ',
