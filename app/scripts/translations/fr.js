...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud HBF différent (par ex. `HBF (Etherscan.io)`, `HBF (Infura.io)` ou `HBF (MyHotelWallet)`) puis revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec MyHotelWallet (ou Mist, Ghbc, Parity et autres clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> HBF ici.](https://myhow.hotelbyte.foundation/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Un outil open source, écrit en Javascript, qui permet de générer des portefeuilles Hotelbyte et d\'envoyer des transactions. ',
FOOTER_1b                   : 'Créé par ',
...
TRANS_warning               : 'L\'emploi des fonctions "HBF seulement" et "ETC seulement" vous fait passer par un contrat. Certains services ont des problèmes avec ces transactions. En savoir plus.',
TRANS_advanced              : '+ Avancé : Ajouter des données',
TRANS_data                  : 'Données',
TRANS_sendInfo              : 'Une transaction standard utilisant 21000 GAS coûtera 0,000441 HBF. Le prix du GAS, de 0.000000021 HBF, que nous avons choisi est légèrement supérieur au minimum assurant une confirmation rapide. Nous ne prenons pas de frais de transaction.',
TRANS_gas                   : 'GAS limite', // changed in ENG to Gas Limit:

/* Send Transaction Modals */
TRANSModal_Title            : 'Transactions "HBF seulement" et "ETC seulement"',
TRANSModal_Content_0        : 'Note sur les transactions et services divers :',
TRANSModal_Content_1        : '**HBF (Transaction standard) :** Génère une transaction standard depuis une adresse directement vers une autre. Son GAS par défaut est de 21000. Il est probable que toute transaction d\'HBF envoyée de cette manière sera réexécutée sur la chaîne ETC.',
TRANSModal_Content_2        : '**HBF seulement :** Envoi à travers le [contrat anti-réexécution de Timon Rapp (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **HBF**.',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec MyHotelWallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et d\'imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth / Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez seulement consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explorer.hotelbyte.org](https://explorer.hotelbyte.org).',
...
ADD_Ledger_0a               : 'Rouvrir MyHotelWallet sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir MyHotelWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir MyHotelWallet sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir MyHotelWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
NODE_Warning                : 'Votre nœud doit être en HTTPS pour vous y connecter via MyHow.hotelbyte.foundation. Vous pouvez [télécharger MyHotelWallet et le lancer localement](https://github.com/kvhnuke/etherwallet/releases/latest) pour vous connecter à un nœud quelconque, ou obtenir un certificat SSL gratuit via [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " contre", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "reçu !", // HBF Received!
SWAP_progress_4             : "Envoi de vos {{orderResult.output.currency}}",
SWAP_progress_5             : "Ordre exécuté",
SWAP_order_CTA              : "Envoyer ", // Please send 1 HBF...
SWAP_unlock                 : "Déverrouillez votre portefeuille pour envoyer des HBF ou des tokens directement depuis cette page.",
...
GHBF_Cheap                  : '(geth-02) Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right. Prix du Gas trop bas pour être accepté',
GHBF_GasLimit               : '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html). Limite de Gas dépassée',
...
GHBF_IntrinsicGas           : '(geth-05) Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. Gas intrinsèque trop bas',
GHBF_InvalidSender          : '(geth-06) Invalid sender. Expéditeur invalide',
GHBF_NegativeValue          : '(geth-07) Negative value. Valeur négative',
...
GHBF_NonExistentAccount     : '(geth-09) Account does not exist or account balance too low. Compte inexistant ou solde du compte trop bas',
...
TranslatorName_1            : '[Simon P](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec MyHotelWallet ?',
...
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de MyHow.hotelbyte.foundation.',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec MyHotelWallet CX ?',
...
HELP_5_Title                : '5) Comment puis-je lancer MyHow.hotelbyte.foundation hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer MyHow.hotelbyte.foundation sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'MyHow.hotelbyte.foundation tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo MyHotelWallet pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment MyHow.hotelbyte.foundation, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_1               : 'MyHotelWallet n\'est pas un portefeuille web. Vous n\'avez pas de compte dessus et rien n\'est jamais stocké sur nos serveurs. Ce n\'est qu\'une interface qui vous permet d\'interagir avec le blockchain.',
HELP_8_Desc_2               : 'Si MyHow.hotelbyte.foundation venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Hotelbyte Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis MyHotelWallet parce qu\'il ne se trouve pas dans MyHotelWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
HELP_8_Desc_3               : 'Vous pouvez maintenant importer facilement votre clef privée non chiffrée et vos fichiers (chiffrés) au format Ghbc/Mist, directement dans geth / Hotelbyte Wallet / Mist. Voir question #12 ci-dessous.',
HELP_8_Desc_4               : 'De plus, la probabilité que nous laissions tomber MyHotelWallet approche zéro. Il ne nous coûte presque rien de le maintenir comme nous n\'y stockons aucune information. Si le domaine venait à être perdu, le logiciel sera toujours disponible publiquement sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Vous pourrez y télécharger le ZIP et le faire tourner localement.',

HELP_8CX_Title              : '8) Que se passe-t-il si MyHotelWallet CX disparaît ?',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par MyHotelWallet CX. De cette manière, si quoi que ce soit arrivait à MyHotelWallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, MyHotelWallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par MyHotelWallet dans geth, Hotelbyte Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Ghbc/Mist JSON de MyHotelWallet v2+.... ',
...
HELP_12_Desc_6              : 'Allez à la section "Téléchargez le fichier JSON file - Format Ghbc/Mist (chiffé)". Cliquez sur le bouton "Télécharger" en dessous. Vous avez maintenant votre fichier *keystore.* ',
HELP_12_Desc_7              : 'Ouvrez l\'application Hotelbyte Wallet. ',
...
HELP_12_Desc_20             : 'Ceci vous invitera à choisir un nouveau mot de passe. C\'est celui que vous utiliserez dans geth / Hotelbyte Wallet / Mist à chaque vois que vos créerez une transaction, alors ne l\'oubliez pas. ',
HELP_12_Desc_21             : 'Après que l\'import ait réussi, supprimez `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'La prochaine fois que vous ouvrirez l\'application Hotelbyte Wallet, votre compte sera listé sous "Accounts". ',
...
HELP_12_Desc_26             : 'Ceci vous invitera à choisir un nouveau mot de passe. C\'est celui que vous utiliserz dans geth / Hotelbyte Wallet / Mist à chaque foiq que vous créerez une transaction, alors ne l\'oubliez pas. ',
HELP_12_Desc_27             : 'Après que l\'import ait réussi, supprimez `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'La prochaine fois que vous ouvrirez l\'application Hotelbyte Wallet, votre compte sera listé sous "Accounts". ',
...
HELP_21_Desc_2              : 'Version longue : Hotelbyte est basé sur la [Cryptographie asymétrique](https://fr.wikipedia.org/wiki/Cryptographie_asymétrique), plus précisément la [cryptographie des courbes elliptiques (ECC)](https://eprint.iacr.org/2013/734.pdf) qui est très couramment employée, non pas uniquement dans Hotelbyte. La plupart des serveurs sont protégés par les ECC. Bitcoin les emploie, ainsi que SSH, TLS et bien d\'autres protocoles. Dans le cas spécifique d\'Hotelbyte, les clefs font 256 bits et sont plus fortes que celles en 128 et 192 bits, encore très employées et toujours considérées comme sûres par les experts.',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser MyHow.hotelbyte.foundation au lieu de cette extension Chrome.',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation).',
