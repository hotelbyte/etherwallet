...
/* Footer */
FOOTER_1                    : 'Avoimen lähdekoodin, javascript työkalu Hotelbyte lompakkojen luomista & varojen siirtoja varten. ',
FOOTER_1b                   : 'Luonut ',
...
SENDModal_Content_4         : 'HUOMAUTUS: Jos kohtaat virheen, sinun täytyy todennäköisesti lisätä HBFiä tilillesi kattaaksesi siirron vaatiman gasin hinnan. Gas maksetaan HBFeinä. ',
...
TRANS_warning               : 'Jos käytät "Vain HBF" tai "Vain ETC" Toimintoja, niin lähetät sopimuksen kautta. Joillakin palveluilla on vaikeuksia hyväksyä näitä siirtoja. Lue lisää. ',
TRANS_advanced              : '+Edistynyt: Lisää Tietoja ',
TRANS_data                  : 'Tiedot ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Tavallinen siirto käyttäen 21000 gasia maksaa 0.000441 HBFiä. Me käytämme hieman-yli-minimin gasin hintaa 0.000000021 HBFiä varmistaaksemme että se louhitaan nopeasti. Me emme veloita siirto maksua. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Vain HBF" ja "Vain ETC" Siirrot ',
TRANSModal_Content_0        : 'Huomautus erilaisista siirroista ja eri palveluista: ',
TRANSModal_Content_1        : '**HBF (Tavallinen Siirto): ** Tämä luo oletusarvoisen siirron osoitteesta toiseen. Siinä on oletus gasina 21000. On todennäköistä että kaikki HBF joka lähetetään tällä tavalla, toistetaan ETC ketjussa. ',
TRANSModal_Content_2        : '**Vain HBF: ** Tämä lähettää [Timon Rappin toiston suojaus sopimuksen kautta (kuten VB on suositellut)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) niin että sinä lähetät vain **HBF** ketjussa. ',
...
GHBF_Balance                    :  '(geth-01) Riittämätön saldo. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_Cheap                      :  '(geth-02) Gasin hinta liian matala hyväksyttäväksi. Gas price too low for acceptance. Try raising the gas price to 21 GWEI via the dropdown in top-right.',
GHBF_GasLimit                   :  '(geth-03) Ylittää blockin gas rajan. Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://myetherwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
GHBF_InsufficientFunds          :  '(geth-04) Riittämätön saldo gas * hinta + arvo. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more HBF to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GHBF_IntrinsicGas               :  '(geth-05) Olennainen gas liian pieni. Intrinsic gas too low. Try raising the gas price to 21 GWEI via the dropdown in top-right or the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again.',
GHBF_InvalidSender              :  '(geth-06) Virheellinen lähettäjä. Invalid sender.',
GHBF_NegativeValue              :  '(geth-07) Negatiivinen arvo. Negative value.',
GHBF_Nonce                      :  "(geth-08) Nonce liian pieni. This TX's [nonce](https://myetherwallet.github.io/knowledge-base/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://myetherwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html).",
GHBF_NonExistentAccount         :  '(geth-09) Tiliä ei ole olemassa tai tilin saldo liian pieni. Account does not exist or account balance too low',
...
TranslatorName_1            : '[Smokyish](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xac9a2c1dd946da64c0dc8e70cec2cfb14304fd4f&value=1.0#send-transaction)',
TranslatorAddr_1            : '',
