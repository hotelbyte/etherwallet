...
sidebar_donation            : 'MyHotelWallet은 개인정보보호와 보안을 위한 무료 오픈 서비스입니다. 기부를 많이 받을수록 우리는 새로운 기능과 다양한 의견을 반영하여 사용자의 희망 사항을 위한 개발 시간을 늘리는 것이 가능해질 수 있습니다. 우리는 단 두명이 세상을 바꾸려 하고 있습니다. 도와주시겠습니까? ',
sidebar_donate              : '기부 ',
...
ADD_Ledger_0a               : 'MyHotelWallet을 보안 연결(SSL)로 다시 연결해주세요. ',
ADD_Ledger_0b               : 'MyHotelWallet을 [Chrome](https://www.google.com/chrome/browser/desktop/) 또는 [Opera](https://www.opera.com/) 브라우저로 다시 열어주세요. ',
...
ADD_DigitalBitbox_0a        : 'MyHotelWallet을 보안 연결(SSL)로 다시 연결해주세요. ',
ADD_DigitalBitbox_0b        : 'MyHotelWallet을 [Chrome](https://www.google.com/chrome/browser/desktop/) 또는 [Opera](https://www.opera.com/) 브라우저로 다시 열어주세요. ',
...
MYWAL_Content_3             : '나중에 이 지갑을 MyHotelWallet CX와 같이 사용하려면, 개인 키/JSON과 비밀번호를 이용하여 수동으로 다시 추가해야 합니다. ',
...
TRANS_data                  : '데이터 ',
TRANS_gas                   : '가스 한도 ',
TRANS_sendInfo              : '21000 가스를 사용하는 표준 트랜잭션은 0.000441 HBF 를 사용합니다. 우리는 최소 가스 가격인 0.000000021 보다 약간 높게 책정하여 전송을 빠르게 합니다. MyHotelWallet은 트랜잭션 수수료를 얻지 않습니다. ',
...
NODE_Warning                : 'MyHow.hotelbyte.foundation을 통해 연결하기 위해서는 HTTPS 노드가 필요합니다. 모든 노드에 연결하려면 [MyHotelWallet 저장소를 다운로드하고 로컬로 실행] (https://github.com/kvhnuke/etherwallet/releases/latest) 할 수 있습니다. 추가로 무료 SSL 인증서를 [LetsEncrypt](https://letsencrypt.org/)에서 받으실 수 있습니다. ',
NODE_Name                   : '노드 명 ',
NODE_Port                   : '노드 포트 ',
...
SWAP_rates                  : "현재 시세 ",
SWAP_init_1                 : "환전하실 ",
SWAP_init_2                 : "에서 ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "수신 완료! ", // HBF Received!
SWAP_progress_4             : "{{order Result.output,currency}} 전송하는 중 ",
SWAP_progress_5             : "주문 완료 ",
SWAP_order_CTA              : "전송해주세요 : ", // Please send 1 HBF...
SWAP_unlock                 : "HBF 또는 토큰을 이 페이지에서 바로 전송하기 위해 당신의 지갑 비밀번호를 해제해주세요. ",
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : '다른 버전의 개인 키를 다운로드하거나 종이 지갑 정보를 다시 인쇄할 수 있습니다. [계좌를 Ghbc/Mist로 가져오기](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)를 진행할 때 필요합니다. 잔액을 확인하려면 [explorer.hotelbyte.org](https://explorer.hotelbyte.org)과 같은 블록체인 조회 서비스를 사용하는 것을 권장합니다. ',
...
ERROR_17                    : '자금이 부족합니다. 트랜잭션을 전송하려는 계좌에 충분한 자금이 없습니다. 가스 비용을 지불하기 위해서는 적어도 **0.01HBF**가 필요합니다. HBF을 추가한 뒤 다시 실행해주세요. ',
...
ERROR_28                    : '지갑에 액세스하기 위해서는 **Keystore 파일과 비밀번호** (또는 개인키)가 필요합니다. 별도로 저장하여 백업해주세요. 만약 그것을 저장하지 않으면 지갑을 복원할 방법이 없습니다. 자세한 내용은 [도움말 페이지](https://myhow.hotelbyte.foundation/#help)를 참고해주세요. ',
...
/* Geth Error Messages */
GHBF_InvalidSender         : '잘못된 전송지입니다. ',
GHBF_Nonce                  : 'Nonce가 너무 낮습니다. ',
GHBF_Cheap                  : '가스 가격이 너무 낮습니다. ',
GHBF_Balance                : '잔액이 부족합니다. ',
GHBF_NonExistentAccount     : '계좌가 존재 하지 않거나 잔액이 부족합니다. ',
GHBF_InsufficientFunds      : '가스 * 가격 + 수량에 대한 자금이 부족합니다.',
GHBF_IntrinsicGas           : '기본 가스가 부족합니다. ',
GHBF_GasLimit               : '블록 가스 한도를 초과하였습니다. ',
GHBF_NegativeValue          : '마이너스 값 ',
...
TranslatorName_1            : '[CoinKorea](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x0080782b9A9A14f7871Bb765eF7041e784D03F00&value=1.0#send-transaction) · [kanghamin](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x7B12655A5aada0b3c053C7ff5aa444Bd666A0163&value=1.0#send-transaction) · [maa](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x14036e41ddb2bd408eaf91597e6dc5220f776ae0&value=1.0#send-transaction) ',
TranslatorAddr_1            : '0x0080782b9A9A14f7871Bb765eF7041e784D03F00 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : '· [Issac](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x594a7773f4e062ccf644e8f122d5612b5f0db3b2&value=1.0#send-transaction) ',
TranslatorAddr_2            : '0x594a7773f4e062ccf644e8f122d5612b5f0db3b2 ',
/* Translator 2             : Insert Comments Here */
TranslatorName_3            : '· [coinmaker](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x80B65285607BAbC4b60a7179A0fa8EB42232b9ad&value=1.0#send-transaction) ',
TranslatorAddr_3            : '0x80B65285607BAbC4b60a7179A0fa8EB42232b9ad ',
/* Translator 3             : Insert Comments Here */
TranslatorName_4            : '· [csjune](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xfc465E0545c1024d04ceA2d6D154F20E7C67C66f&value=1.0#send-transaction) ',
TranslatorAddr_4            : '0xfc465E0545c1024d04ceA2d6D154F20E7C67C66f ',
/* Translator 4             : Insert Comments Here */
TranslatorName_5            : '· [sadfrog](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0x608c96865c3d1364ffc5137e5ac78b57e58714d4&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : '**이더리움, MyHow.hotelbyte.foundation & MyHotelWallet CX, 그리고 우리가 사용하는 JavaScript 라이브러리는 활발하게 개발되고 있습니다. ** 우리가 철저하게 테스트를 진행하여 수만 개의 지갑이 전 세계 사람들에 의해 성공적으로 만들어졌지만 예상치 못한 일이 발생하여 HBF를 잃을 가능성이 항상 존재합니다. 항상 조심해주세요. 만약 무슨 일이 발생한다면, 유감스럽지만 **우리는 잃어버린 이더리움에 대한 책임을 지지 않습니다.** ',
HELP_Remind_Desc_2          : 'MyHow.hotelbyte.foundation 과 MyHotelWallet CX는 웹 지갑이 아닙니다. 계정을 만들거나 우리에게 당신이 가진 이더리움을 주면 안 됩니다. 모든 데이터는 당신의 컴퓨터와 브라우저에 남아 있을 것입니다. 우리는 당신이 쉽게 당신의 정보를 만들고, 저장하고, 접근하고 블록체인과 상호 작용할 수 있도록 도울 것입니다. ',
...
HELP_0_Desc_1               : 'MyHotelWallet은 새로운 지갑을 생성할 수 있는 기능을 제공하므로 거래소에 이더리움을 두지 않고 직접 저장할 수 있습니다. 이 과정은 전적으로 당신의 컴퓨터에서 발생하고 우리의 서버에서 발생하지 않습니다. 따라서 새로운 지갑을 만들 때 **안전하게 백업’해야 합니다**. ',
...
HELP_2b_Title               : '2b) 어떻게 하면 MyHotelWallet을 이용해 안전하게 오프라인, 콜드 스토리지로 자산을 보관할 수 있나요?  ',
...
HELP_3_Desc_3               : 'MyHow.hotelbyte.foundation 에서 "지갑 정보 보기" 페이지로 이동합니다. ',
...
HELP_3_Desc_8               : '많은 양의 이더리움을 MyHotelWallet 으로 전송하기 전에, 소량의 이더리움을 전송해 보는 것을 권장합니다. 0.001 이더리움을 지갑으로 전송하고, 지갑을 열어 받은 이더리움을 확인하고, 다시 0.001 이더리움을 다른 주소로 전송하여 모든 과정이 잘 작동하는지 확인해주세요. ',
...
HELP_4CX_Title              : '4) 이더리움을 MyHotelWallet CX를 사용하여 전송하는 방법이 궁급합니다. ',
...
HELP_5_Title                : '5) MyHow.hotelbyte.foundation 을 오프라인/로컬에서 사용할 수 있나요?  ',
HELP_5_Desc_1               : 'MyHotelWallet을 GitHub 서버가 아닌 본인의 컴퓨터에서 이용할 수 있습니다. 오프라인 상태에서 지갑을 생성할 수 있으며, "오프라인 트랜잭션" 페이지에서 트랜잭션을 전송할 수 있습니다. ',
HELP_5_Desc_7               : 'MyHow.hotelbyte.foundation 은 이제 본인의 컴퓨터에서 구동됩니다. ',
HELP_5_Desc_8               : '아직 사용이 미숙할 때는, ‘index.html’ 뿐만 아니라 웹사이트를 가동하는 전체 폴더를 수정하지 말아 주세요. ',
HELP_5_Desc_9               : '우리는 MyHow.hotelbyte.foundation을 주기적으로 업데이트하고 있으므로 당신이 정기적으로 저장소의 업데이트된 버전을 사용하는 것을 권장합니다. ',
...
HELP_8_Title                : '8) MyHotelWallet 서버가 다운되면 어떻게 되나요? ',
HELP_8_Desc_1               : 'MyHotelWallet은 웹 지갑이 아닙니다. 서버에는 로그인은 물론 어떠한 것도 저장되지 않습니다. MyHotelWallet은 단지 블록체인에 접근 하게 해주는 도구입니다. ',
HELP_8_Desc_2               : '만약 MyHow.hotelbyte.foundation 이 다운된다면, 다른 대안 도구 (geth 또는 Hotelbyte Wallet / Mist 등)을 사용해야 합니다. MyHotelWallet 에서 이더리움을 꺼내야 할 필요는 없습니다. 이더리움들은 MyHow.hotelbyte.foundation 을 통해서 생성된 지갑 내에 존재합니다. ',
HELP_8_Desc_3               : '암호화되지 않은 개인 키와 암호화된 Ghbc/Mist 형식의 파일은 쉽게 geth / 이더리움 지갑 / Mist에서 불러올 수 있습니다. 아래의 질문 #12를 확인해주세요. ',
HELP_8_Desc_4               : '또한, MyHotelWallet 이 다운 될 가능성은 희박합니다. 우리는 어떠한 정보도 저장하지 않기 때문에 비용이 들지 않습니다. 도메인이 다운되더라도, 항상 공개적으로  [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages)을 통해 로컬 지갑을 시작할 수 있습니다. ZIP 파일을 다운 받아주세요. ',

HELP_8CX_Title             : '8) MyHotelWallet CX가 사라지면 어떻게 되나요? ',
HELP_8CX_Desc_1             : '우선, 모든 정보는 MyHotelWallet 서버가 아닌 사용자의 컴퓨터에 저장됩니다. 오해할 수도 있지만, Chrome 확장 프로그램 화면은 우리의 서버에서 불러온 것이 아닙니다. 전부 사용자의 컴퓨터에 저장 되어있습니다. ',
HELP_8CX_Desc_2             : '즉, **매우 중요** MyHotelWallet CX 로 새로 만든 지갑 정보는 모두 백업해 두어야 합니다. 만약 컴퓨터에 문제가 생기거나 Chrome 확장 프로그램에 문제가 생겨도 백업해둔 파일로 지갑에 접근할 수 있습니다. #2a에서 지갑을 어떻게 백업 하는 지 확인할 수 있습니다. ',
HELP_8CX_Desc_3             : '어떤 이유로 MyHotelWallet CX 가 Chrome 스토어에서 사라져도, Github 에서 소스를 다운 받아 수동으로 사용할 수 있습니다. 위의 #5를 확인해주세요. ',
...
HELP_12_Title               : '12) MyHotelWallet으로 만든 지갑을 geth / 이더리움 지갑 / Mist로 가져오려면 어떻게 해야 하나요? ',
HELP_12_Desc_1              : 'MyHotelWallet v2 +의 Geth / Mist JSON 파일 사용하기… ',
...
HELP_SecCX_Title            : '보안 - MyHotelWallet CX ',
...
HELP_SecCX_Desc_6           : '닉네임과 지갑 주소를 암호화하면 계좌 잔액과 닉네임들을 확인할 때마다 비밀번호를 입력해야 합니다. 보안이 걱정된다면 Chrome 확장 프로그램 대신 MyHow.hotelbyte.foundation 을 사용해주세요. ',
...
HELP_Sec_Desc_4             : '이 URL을 확인해보세요. -- 이 사이트는 GitHub를 통해 소스가 공개되어 있으며 다음 링크에서 확인하실 수 있습니다. : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation). ',
