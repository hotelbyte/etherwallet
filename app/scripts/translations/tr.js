...
sidebar_donation            : 'MyHotelWallet gizlilik ve güvenlike adanmış ücretsiz ve açık kaynak kodlu bir hizmettir. Ne kadar cok bagis edilirse o kadar cok yeni özellik programlamaya, görüşlerinizi işlemeye yatitim yapabiliriz. Biz sadece dünyayı değiştirmek isteyen iki kişiyiz. Bize yardım edermisin? ',
...
TRANS_warning               : '"Yalnızca HBF" ya da "Yalnızca ETC" fonksiyonu kullanıyorsan, bir sözleşme yoluyla gönderiyorsun. Bazı servisler bu işlemleri kabul etmekde sorunları var. Daha fazla oku. ',
TRANS_advanced              : '+Gelişmiş: Veri ekle ',
TRANS_data                  : 'Veri ',
TRANS_gas                   : 'Gas Limiti ',
TRANS_sendInfo              : '21000 gaz kullanan standart bir islem 0.000441 HBF ile mal olur. Biz hizli bir sekilde mayinlanmasi için, 0.000000021 HBF\'dan biraz daha yüksek gaz fiyatini kullaniyoruz. Biz herhangi bir islem ücreti almiyoruz. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Yalnızca HBF" and "Yalnızca ETC" islemler ',
TRANSModal_Content_0        : 'Farklı işlemler ve farklı hizmetleri hakkında bir not: ',
TRANSModal_Content_1        : '**HBF (Standart islem): ** Bu standart bir islem baslatir bir hesapten direkt baska bir hesapa. Standart gas 21000\'dir. Bu islemlen gönderileren islem ETC zincirinde\'de yer bulabilir. ',
TRANSModal_Content_2        : '**Only HBF: ** This sends via [Timon Rapp\'s replay protection contract (as recommended by VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) so that you only send on the **HBF** chain. ',
...
ERROR_17                    : 'Account you are sending from does not have enough funds. If sending tokens, you must have 0.01 HBF in your account to cover the cost of gas. ', // 17
...
ERROR_28                    : 'Ilerde cüzdanini acmak icin **Keystore dosyan ve parolan veya özel anahtarin** lazim olacak. Lütfen kaydet ve dista yedekle! Kaydedilmemiş cüzdanini kurtarmanin hiçbir yolu yoktur. Talimatlar icin yardim [help page](https://myhow.hotelbyte.foundation/#help) sayfasini oku ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Geçersiz gönderici ',
GHBF_Nonce                  : 'Nonce too low ',
GHBF_Cheap                  : 'Gas price too low for acceptance ',
GHBF_Balance                : 'Insufficient balance ',
GHBF_NonExistentAccount     : 'Account does not exist or account balance too low ',
GHBF_InsufficientFunds      : 'Insufficient funds for gas * price + value ',
GHBF_IntrinsicGas           : 'Intrinsic gas too low ',
GHBF_GasLimit               : 'Gaz block sınırını aşıyor ',
GHBF_NegativeValue          : 'Negatif değer ',
...
TranslatorName_1            : '[ffidan61](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=0xF1Fdf8635cc35a084B97905F62a021cAd71fbC21&value=1.0#send-transaction) ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send Hotelcoin" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send Hotelcoin" Page ',

HELP_5_Title                : '5) How do I run MyHow.hotelbyte.foundation offline/locally? ',
HELP_5_Desc_1               : 'You can run MyHow.hotelbyte.foundation on your computer instead of from the GitHub servers. You can generatea a wallet completely offline and send transactions from the "Offline Transaction" page. ',
...
HELP_9_Title                : '9) Is the "Send Hotelcoin" page offline? ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "Send Hotelcoin". This will broadcast your transaction. ',
...
HELP_SecCX_Title            : 'Güvenlik - MyHotelWallet CX ',
