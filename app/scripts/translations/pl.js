...
tx_notFound_4               : 'Użyj menu w prawym górnym rogu aby wybrać inny węzeł HBF (np. `HBF (Etherscan.io)` lub `HBF (Infura.io)` lub `HBF (MyHotelWallet)`) i sprawdź ponownie.',
...
tx_FoundOnChain_3           : '**Jeśli nie pojawią się żadne komunikaty o błędzie, to Twoja transakcja została pomyślnie wysłana.** Twój HBF lub Tokeny są tam, gdzie zostały wysłane. Jeśli jednak HBF lub Tokeny nie pojawią się tam, gdzie zostały wysłane i minęły ponad 24 godziny od momentu wysłania, [skontaktuj się z którymś z serwisów](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Wyślij im *link* do Twojej transakcji i uprzejmie poproś o zbadanie sytuacji.',
...
MEW_Tagline                 : 'Portfel Hotelbyte - Open Source, JavaScript, Client-Side ',
CX_Tagline                  : 'Portfel Hotelbyte, Rozszerzenie Chrome - Open Source, JavaScript, Client-Side ',

/* Footer */
FOOTER_1                    : 'Narzędzie do generowania portfeli Hotelbyte i wysyłania transakcji - otwarto-źródłowe, javascrypt\'owe, strony klienta ',
FOOTER_1b                   : 'Twórcy: ',
FOOTER_2                    : 'Darowizny: ',
...
TRANS_warning               : 'Jeśli używasz funkcji "Tylko HBF" lub "Tylko ETC" wysyłasz przez kontrakt. Niektóre serwisy mają problemy z rozpoznawaniem tego typu transakcji. Czytaj dalej. ',
TRANS_advanced              : '+Zaawansowane: Dodaj Dane ',
TRANS_data                  : 'Dane ',
TRANS_sendInfo              : 'Standardowa transakcja, zużywająca 21000 paliwa, będzie kosztować 0.000441 HBF. My używamy ceny paliwa nieco-powyżej-minimum, co odpowiada 0.000000021 HBF aby upewnić się, że zostanie szybko zatwierdzona. Nie pobieramy żadnych dodatkowych opłat. ',
TRANS_gas                   : 'Limit Paliwa ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transakcje "Tylko HBF" i "Tylko ETC" ',
TRANSModal_Content_0        : 'Informacje na temat różnych transakcji i różnych odbiorców: ',
TRANSModal_Content_1        : '**HBF (Standardowa Transakcja): ** generuje standardową transakcję bezpośrednio z jednego adresu do drugiego. Domyślnie spala 21000 paliwa. Prawdopodobnie transakcja HBF zostanie powielona na łańcuchu ETC jeżeli posiadasz obie waluty na tym samym adresie. ',
TRANSModal_Content_2        : '**Tylko HBF: ** wysyła przez [Kontrakt zapobiegający powielaniu Timon\'a Rapp\'a (zalecany przez VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), który wysyła środki tylko na łańcuchu **HBF**. ',
...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim MyHotelWallet CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Ta zakładka pozwoli Ci na odczyt kluczy prywatnych, pobranie kopii portfeli oraz wydrukowanie portfeli papierowych. Pobrane za jej pomocą portfele możesz [zaimportować do Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Jeśli chcesz sprawdzić stan Twojego konta, zalecamy użyć eksploratora bloków np. [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
ADD_Ledger_2                : 'Otwórz aplikację Hotelbyte (lub aplikację kontraktu) ',
...
ADD_Ledger_0a               : 'Otwórz MyHotelWallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz MyHotelWallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Otwórz MyHotelWallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_DigitalBitbox_0b        : 'Otwórz MyHotelWallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Twój węzeł musi obsługiwać HTTPS, aby można było się połączyć z nim przez MyHow.hotelbyte.foundation. Możesz pobrać [repozytorium MyHotelWallet](https://github.com/kvhnuke/etherwallet/releases/latest) i uruchomić lokalnie aby połączyć się z dowolnym węzłem. Możesz też pobrać darmowy certyfikat SSL przez [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " na ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Otrzymano! ", // HBF Received!
SWAP_progress_4             : "Wysyłanie Twoich {{orderResult.output.currency}} ",
SWAP_progress_5             : "Zlecenie Zakończone ",
SWAP_order_CTA              : "Wyślij ", // Please send 1 HBF...
SWAP_unlock                 : "Odblokuj Twój portfel, aby wysłać HBF lub Tokeny wprost z tej strony. ",
...
ERROR_17                    : 'Niewystarczające środki. Konto, z którego wysyłasz transakcję nie posiada wystarczających funduszy. Musisz mieć **0.01 HBF** na koncie, aby pokryć koszty paliwa. Doładuj konto i spróbuj ponownie. ',
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](https://myhow.hotelbyte.foundation/#help) po instrukcje. ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Nieprawidłowy nadawca ',
GHBF_Nonce                  : 'Wyróżnik transakcji za niski ',
GHBF_Cheap                  : 'Cena paliwa poniżej akceptacji ',
GHBF_Balance                : 'Niewystarczająca ilość środków na koncie ',
GHBF_NonExistentAccount     : 'Konto nie istnieje lub niewystarczająca ilość środków ',
GHBF_InsufficientFunds      : 'Niewystarczająca ilość środków na paliwo * cena + kwota ',
GHBF_IntrinsicGas           : 'Paliwo poniżej ilości obowiązkowej ',
GHBF_GasLimit               : 'Przekroczono limit paliwa na blok ',
GHBF_NegativeValue          : 'Ujemna wartość ',
...
HELP_0_Desc_1               : 'MyHotelWallet daje Ci możliwość generowania nowych portfeli abyś mógł przechowywać własne środki samodzielnie, nie na portalu wymiany walut. Ten proces odbywa się w całości na Twoim komputerze, nie na naszych serwerach. Z tego powodu, gdy generujesz nowy portfel, **to Ty jesteś odpowiedzialny za jego bezpieczne przechowywanie**. ',
...
HELP_2b_Title               : '2b) Jak mogę utworzyć portfel w 100% odizolowany od sieci globalnej (Cold Wallet) wykorzystując MyHotelWallet? ',
...
HELP_3_Desc_3               : 'Przejdź na zakładkę "Wyświetl informacje o portfelu" na stronie MyHow.hotelbyte.foundation. ',
...
HELP_4CX_Title              : '4)Jak wysłać Ether używając MyHotelWallet CX? ',
...
HELP_5_Title                : '5) Jak uruchomić MyHotelWallet offline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić MyHotelWallet lokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'MyHotelWallet działa teraz w całości na Twoim komputerze. ',
HELP_5_Desc_8               : 'W razie gdybyś nie wiedział, musisz zachować cały folder, aby strona działała prawidłowo, nie tylko `index.html`. Nie ruszaj i nie przenoś nic innego w folderze. Jeżeli zachowujesz kopie repozytorium MyHotelWallet na przyszłość, zalecamy przechowywać je w formie spakowanego pliku ZIP, aby mieć pewność, że jego zawartość się nie zmieniła. ',
HELP_5_Desc_9               : 'Ponieważ ciągle aktualizujemy MyHotelWallet, zalecamy co jakiś czas aktualizować  zapisaną wersję repozytorium. ',
...
HELP_8_Desc_1               : 'MyHotelWallet nie jest usługą portfela internetowego. Nie posiadasz loginu i nic nie jest zapisywane na naszych serwerach. To tylko interfejs, który pozwala korzystać z sieci Hotelbyte. ',
HELP_8_Desc_2               : 'Jeżeli MyHow.hotelbyte.foundation zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Hotelbyte Wallet / Mist) na korzystanie z sieci Hotelbyte. Nie musiałbyś jednak wypłacić swoich środków z MyHotelWallet, ponieważ one nie znajdują się na MyHotelWallet, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
HELP_8_Desc_3               : 'Możesz w każdej chwili, w bardzo prosty sposób, zaimportować swoje nieszyfrowane klucze prywatne lub szyfrowane pliki w formacie Ghbc/Mist wprost do geth / Hotelbyte Wallet / Mist. Zobacz pytanie 12 poniżej. ',
HELP_8_Desc_4               : 'W dodatku prawdopodobieństwo zamknięcia przez nas strony MyHow.hotelbyte.foundation jest bliskie zeru. Koszty utrzymania strony są prawie żadne, ponieważ nie przechowujmy żadnych informacji. Jeśli nawet strona zostanie zamknięta, jest ona również i zawsze będzie publicznie dostępna na [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Możesz ściągnąć paczkę ZIP i uruchomić MyHotelWallet lokalnie na własnym komputerze. ',

HELP_8CX_Title              : '8) Co się stanie jeżeli MyHotelWallet CX zniknie? ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą MyHotelWallet CX. W ten sposób, jeżeli cokolwiek stanie się MyHotelWallet CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu MyHotelWallet CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w MyHotelWallet do geth / Hotelbyte Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Ghbc/Mist z MyHotelWallet v2+.... ',
...
HELP_12_Desc_7              : 'Uruchom aplikację Hotelbyte Wallet. ',
...
HELP_12_Desc_20             : 'Zostaniesz zapytany o hasło. To będzie hasło portfela w geth / Hotelbyte Wallet / Mist, które należy podać przy każdej transakcji, nie zapomnij tego hasła. ',
HELP_12_Desc_21             : 'Po zaimportowaniu portfela, usuń `nic_specjalnego_usun_mnie.txt` ',
HELP_12_Desc_22             : 'Po ponownym uruchomieniu aplikacji Hotelbyte Wallet Twój portfel pojawi się na zakładce "Accounts". ',
...
HELP_12_Desc_26             : 'Zostaniesz zapytany o hasło. To będzie hasło portfela w geth / Hotelbyte Wallet / Mist, które należy podać przy każdej transakcji, nie zapomnij tego hasła. ',
HELP_12_Desc_27             : 'Po zaimportowaniu portfela, usuń `nic_specjalnego_usun_mnie.txt` ',
HELP_12_Desc_28             : 'Po ponownym uruchomieniu aplikacji Hotelbyte Wallet Twój portfel pojawi się na zakładce "Accounts". ',
...
HELP_21_Desc_2              : 'Długa wersja (dla przedszkolaka): Hotelbyte bazuje na [Kryptografii Klucza Publicznego (ECC)](https://pl.wikipedia.org/wiki/Kryptografia_klucza_publicznego), a dokładnie na [Kryptografii Krzywych Eliptycznych](https://eprint.iacr.org/2013/734.pdf) które są bardzo szeroko stosowane, nie tylko w Hotelbyte. Większość serwerów jest chroniona przez ECC. Kolejne przykłady to Bitcoin, SSH, TLS i wiele innych. Klucze w Hotelbyte to dokładnie odmiana 256-bitowa, która jest silniejsza niż 128-bitowa i 192-bitowa, które również są wciąż szeroko stosowane oraz uznawane przez ekspertów za bezpieczne. ',
HELP_21_Desc_3              : 'W tego typu zabezpieczeniu mamy 2 klucze: klucz prywatny i klucz publiczny. Z klucza prywatnego możemy szybko otrzymać klucz publiczny, ale otrzymanie klucza prywatnego z klucza publicznego jest niemożliwe. Biorąc pod uwagę, że cały internet i wszystkie sekrety świata używają tej metody kryptograficznej oznacza, że gdyby istniał sposób na otrzymanie klucza prywatnego z publicznego, to utrata Twoich środków z konta Hotelbyte byłaby najmniejszym zmartwieniem w świecie. ',
