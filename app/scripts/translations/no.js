...
tx_notFound_4               : 'Bruk rullegardinmenyen øverst til høyre og velg en annen HBF-node. (f.eks. `HBF (Etherscan.io)` eller `HBF (Infura.io)` eller `HBF (MyHotelWallet)`), og sjekk igjen.',
...
tx_FoundOnChain_3           : '**Hvis du ikke ser noen feil, var transaksjonen vellykket.** Dine HBF eller Tokens er der du sendte dem. Hvis du ikke ser disse HBF eller Tokens der du sendte dem, og det har gått mer enn 24 timer, vennligst [kontakt vedkommende service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send dem en *lenke* til transaksjonen din og spør dem pent om å se på situasjonen din.',
...
GEN_Help_12                 : 'Bruk den sammen med passordet du oppga til å låse opp lommeboken din via MyHotelWallet (eller Mist, Ghbc, Parity og andre lommebok-klienter.) ',
...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> HBF her](https://myhow.hotelbyte.foundation/helpers.html)',
...
NAV_SendEther               : 'Send Hotelcoin & Tokens ',
...
/* Footer */
FOOTER_1                    : 'Et åpen-kildekode-, javascript-, klient-side-verktøy for å opprette Hotelbyte-lommebøker & sende transaksjoner. ',
FOOTER_1b                   : 'Skapt av ',
...
ADD_Ledger_2                : 'Åpne Hotelbyte-applikasjonen (eller kontraktsapplikasjonen) ',
...
ADD_Ledger_0a               : 'Åpne MyHotelWallet på nytt på en sikker (SSL) forbindelse. ',
ADD_Ledger_0b               : 'Åpne MyHotelWallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Åpne MyHotelWallet på nytt på en sikker (SSL) forbindelse. ',
ADD_DigitalBitbox_0b        : 'Åpne MyHotelWallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
TRANS_warning               : 'Hvis du bruker "Kun HBF"- eller "Kun ETC"-funksjonene, sender du via en kontrakt. Noen tjenester har problemer med å akseptere disse transaksjonene. Les mer. ',
TRANS_advanced              : '+Avansert: Legg til data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'En standard transaksjon som bruker 21000 gas vil koste 0,000441 HBF. Vi bruker en litt-over-minimum gas-pris på 0,000000021 HBF for å sikre at transaksjonen blir raskt behandlet. Vi tar ikke noe transaksjonsgebyr. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Kun HBF"- og "Kun ETC"-transaksjoner ',
TRANSModal_Content_0        : 'En notis om forskjellige transaksjoner og tjenester: ',
TRANSModal_Content_1        : '**HBF (Standardtransaksjon): ** Dette Oppretter en standardtransaksjon direkte fra en adresse ti en annen. Den har standard gas på 21000. Det er sannsynlig at HBF som sendes med denne metoden også vil bli sendt som ETC på ETC-kjeden (hvis kontoen inneholder både HBF og ETC). Dette er anbefalt metode hvis kontoen kun inneholder HBF. ',
TRANSModal_Content_2        : '**Kun HBF: ** Dette sender via [Timon Rapp\'s replay-beskyttelseskontrakt (som anbefalt av VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) slik at du kun sender på **HBF**-kjeden. ',
...
SWAP_init_2                 : " med ", // "I want to swap my X HBF for X BTC"
...
SWAP_progress_3             : "Mottatt! ", // HBF Received!
SWAP_progress_4             : "Sender dine {{orderResult.output.currency}} ",
SWAP_progress_5             : "Ordre fullført ",
SWAP_order_CTA              : "Vennligst send ", // Please send 1 HBF...
SWAP_unlock                 : "Lås opp din lommebok for å sende HBF eller Tokens direkte fra denne siden. ",
...
MYWAL_Content_3             : 'Hvis du ønsker å bruke denne lommeboken med din MyHotelWallet Chrome-utvidelse i fremtiden, må du manuelt legge den til igjen ved å bruke den private nøkkelen/JSON og passord. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Dette gir deg muligheten til å laste ned ulike versjoner av private nøkler og skrive ut papirlommeboken din på nytt. Du vil kanskje gjøre dette for å [importere kontoen din til Ghbc/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Hvis du bare ønsker å sjekke saldoen din, anbefaler vi at du bruker en "blockchain explorer" som f.eks. [explorer.hotelbyte.org](https://explorer.hotelbyte.org). ',
...
/* Geth Error Messages */
GHBF_InvalidSender          : 'Feil på avsender ',
GHBF_Nonce                  : 'For liten Nonce ',
GHBF_Cheap                  : 'Gas-pris for lav til å kunne aksepteres ',
GHBF_Balance                : 'Utilstrekkelig saldo ',
GHBF_NonExistentAccount     : 'Kontoen eksisterer ikke eller saldoen er for lav ',
GHBF_InsufficientFunds      : 'Utilstrekkelig med midler for gas * pris + verdi ',
GHBF_IntrinsicGas           : 'Gas-egenverdi for lav ',
GHBF_GasLimit               : 'Overskrider blokkens gas-grense ',
GHBF_NegativeValue          : 'Negativ verdi ',
...
TranslatorName_1            : '[mrstormlars](https://myhow.hotelbyte.foundation/?gaslimit=21000&to=mrstormlars.eth&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_Remind_Desc_1          : '**Hotelbyte, MyHow.hotelbyte.foundation & MyHotelWallet CX, og noen av de underliggende Javascript-bibliotekene vi benytter er under aktiv utvikling.** Selv om vi har testet grundig, og titusenvis av lommebøker har blitt opprettet uten feil av folk over hele kloden, så er det alltid en liten mulighet for at noe uventet kan skje som kan medføre at dine HBF kan tapes. Vennligst ikke invester mer enn du er villig til å tape, and vær så snill å være forsiktig. Hvis noe skulle skje, er vi lei oss for det, men **vi er ikke ansvarlige for eventuelt tapte etere**. ',
HELP_Remind_Desc_2          : 'MyHow.hotelbyte.foundation & MyHotelWallet CX er ikke "web wallets" (internettlommebøker). Du oppretter ikke en konto eller gir oss dine ethere for oppbevaring hos oss. Alle data forblir på din PC / i din nettleser. Vi gjør det enkelt for deg å opprette, lagre og få tilgang til din informasjon og samhogle med blokkjeden. ',
...
HELP_1_Desc_1               : 'Gå til "Send Hotelcoin & Tokens"-siden. ',
...
HELP_2b_Title               : '2b) Hvordan kan jeg lagre ether sikkert / offline / "kaldt" med MyHotelWallet? ',
...
HELP_3_Desc_3               : 'Naviger til MyHow.hotelbyte.foundation sin "Vis lommebok-info"-side. ',
...
HELP_4_Desc_2               : 'Naviger til "Send Hotelcoin & Tokens"-siden. ',
...
HELP_4CX_Title              : '4) Hvordan sender jeg ether med MyHotelWallet CX (Chrome-utvidelsen)? ',
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send Hotelcoin & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send Hotelcoin & Tokens"-siden ',

HELP_5_Title                : '5) Hvordan kan jeg bruke MyHow.hotelbyte.foundation offline/lokalt? ',
HELP_5_Desc_1               : 'Du kan bruke MyHow.hotelbyte.foundation på datamaskinen din i stedet for fra GitHub-serverne. Du kan opprette en lommebok fullstendig frakoblet fra internett, og sende transaksjoner fra "Send offline"-siden. ',
HELP_5_Desc_7               : 'MyHow.hotelbyte.foundation kjører nå utelukkende på din datamaskin. ',
HELP_5_Desc_8               : 'I tilfelle du ikke er så vant med dette: du må beholde hele mappen for å kunne kjøre nettsiden, ikke bare `index.html`. Ikke rør eller flytt rundt på noe i mappen. Hvis du lagrer en backup av MyHotelWallet-repoet for framtiden, anbefaler vi å kun lagre zip-fila så du kan være sikker på at innholdet i mappen forblir intakt. ',
HELP_5_Desc_9               : 'Siden vi oppdaterer MyHow.hotelbyte.foundation hele tiden, anbefaler vi at du oppdaterer din lagrede versjon av repoet jevnlig. ',
...
HELP_7_Desc_1               : 'Naviger til "Send Hotelcoin & Tokens"-siden. ',
...
HELP_8_Desc_1               : 'MyHotelWallet er ikke en nett-lommebok (web wallet). Du har ingen innlogging og ingenting blir noensinne lagret på våre servere. Det er ganske enkelt et grensesnitt som tillater deg å samhandle med blokkjeden. ',
HELP_8_Desc_2               : 'Hvis MyHow.hotelbyte.foundation går ned, må du finne en annen måte (som f.eks. geth eller Hotelbyte Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av MyHotelWallet, fordi den ikke befinner seg i MyHotelWallet. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
HELP_8_Desc_3               : 'Du kan nå svært enkelt importere din ukrypterte private nøkkel og dine Ghbc/Mist-format (krypterte) filer direkte inn i geth / Hotelbyte Wallet / Mist. Se spørsmål #12 nedenfor. ',
HELP_8_Desc_4               : 'I tillegg er sannsynligheten for at vi tar ned MyHotelWallet svært liten. Det koster oss nesten ingenting å opprettholde den siden vi ikke lagrer noen informasjon. Hvis vi tar ned domenet, er det fortsatt, og vil alltid være, offentlig tilgjengelig på [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Du kan laste ned zip-fila der og kjøre den lokalt. ',

HELP_8CX_Title              : '8) Hva skjer hvis MyHotelWallet CX (Chrome-utvidelsen) forsvinner? ',
...
HELP_8CX_Desc_2             : 'Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med MyHotelWallet CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med MyHotelWallet CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ',
HELP_8CX_Desc_3             : 'Hvis MyHotelWallet CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ',

HELP_9_Title                : '9) Er "Send Hotelcoin & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send Hotelcoin & Tokens". Dette vil kringkaste transaksjonen din. ',

HELP_12_Title               : '12) Hvordan kan jeg importere en lommebok opprettet med MyHotelWallet til geth / Hotelbyte Wallet / Mist? ',
HELP_12_Desc_1              : 'Ved å bruke en Ghbc/Mist JSON-fil fra MyHotelWallet v2+.... ',
...
HELP_12_Desc_6              : 'Finn "Last ned JSON-fil - Ghbc/Mist-format (kryptert)"-seksjonen. Trykk "Last ned"-knappen nedenfor. Du har nå fått keystore-filen til lommeboken din. ',
HELP_12_Desc_7              : 'Åpne "Hotelbyte Wallet"-programmet. ',
...
HELP_12_Desc_20             : 'Du vil bli bedt om å lage et nytt passord. Dette er passordet du vil bruke i geth / Hotelbyte Wallet / Mist hver gang du skal sende en transaksjon, så ikke glem det. ',
HELP_12_Desc_21             : 'Etter at du har lykkes med å importere kontoen, slett `ikke_noe_spesielt_slett_meg.txt` ',
HELP_12_Desc_22             : 'Neste gangen du åpner "Hotelbyte Wallet"-programmet, vil kontoen din være listet under "Accounts". ',
...
HELP_12_Desc_26             : 'Du vil bli bedt om å lage et nytt passord. Dette er passordet du vil bruke i geth / Hotelbyte Wallet / Mist hver gang du skal sende en transaksjon, så ikke glem det. ',
HELP_12_Desc_27             : 'Etter at du har lykkes med å importere kontoen, slett `ikke_noe_spesielt_slett_meg.txt` ',
HELP_12_Desc_28             : 'Neste gangen du åpner "Hotelbyte Wallet"-programmet, vil kontoen din være listet under "Accounts". ',
...
HELP_21_Desc_2              : 'Lang ELI5-versjon: Hotelbyte er basert på [Offentlig nøkkel-kryptografi](https://en.wikipedia.org/wiki/Public-key_cryptography), og mer spesifikt [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf), som er svært utbredt, ikke bare i Hotelbyte. De fleste servere er beskyttet via ECC. Bitcoin bruker den samme, likeså SSH og TLS og mange flere. Hotelbyte-nøklene er 256-bit nøkler, som er sterkere enn 128-bit og 192-bit, som også er mye brukt og fortsatt betraktes som sikre av ekspertene. ',
...
HELP_SecCX_Desc_6           : 'Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke MyHow.hotelbyte.foundation i stedet for denne Chrome-utvidelsen. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send Hotelcoin & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
HELP_Sec_Desc_4             : 'Sjekk nettsideadressen (URL) -- Denne siden blir drevet gjennom GitHub og du kan se kildekoden her: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) til domenet: [https://myhow.hotelbyte.foundation](https://myhow.hotelbyte.foundation). ',
